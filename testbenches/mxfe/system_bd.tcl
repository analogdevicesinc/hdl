...
set adc_fifo_samples_per_converter [expr 16*1024]
## DAC FIFO depth in samples per converter
set dac_fifo_samples_per_converter [expr 16*1024]
...
#ad_connect /axi_mxfe_rx_jesd/rx/phy_header GND
if {$JESD_MODE == "8B10B"} {
  connect_bd_net [get_bd_ports dma_rst_n] [get_bd_pins rx_device_clk_rstgen/ext_reset_in]
}
...
if {$JESD_MODE == "8B10B"} {
  ad_connect axi_cfg_interconnect/M00_AXI axi_mxfe_rx_xcvr/s_axi
  ad_connect axi_cfg_interconnect/M01_AXI axi_mxfe_tx_xcvr/s_axi
} else {
  ad_connect axi_cfg_interconnect/M00_AXI jesd204_phy_121/s_axi
  ad_connect axi_cfg_interconnect/M01_AXI jesd204_phy_126/s_axi

}
ad_connect axi_cfg_interconnect/M02_AXI rx_mxfe_tpl_core/s_axi
ad_connect axi_cfg_interconnect/M03_AXI tx_mxfe_tpl_core/s_axi
ad_connect axi_cfg_interconnect/M04_AXI axi_mxfe_rx_jesd/s_axi
ad_connect axi_cfg_interconnect/M05_AXI axi_mxfe_tx_jesd/s_axi
ad_connect axi_cfg_interconnect/M06_AXI axi_mxfe_rx_dma/s_axi
ad_connect axi_cfg_interconnect/M07_AXI axi_mxfe_tx_dma/s_axi
...
ad_connect mng_rst_n axi_cfg_interconnect/M02_ARESETN
ad_connect mng_rst_n axi_cfg_interconnect/M03_ARESETN
ad_connect mng_rst_n axi_cfg_interconnect/M04_ARESETN
ad_connect mng_rst_n axi_cfg_interconnect/M05_ARESETN
ad_connect mng_rst_n axi_cfg_interconnect/M06_ARESETN
ad_connect mng_rst_n axi_cfg_interconnect/M07_ARESETN
...
ad_connect mng_clk axi_cfg_interconnect/M06_ACLK
ad_connect mng_clk axi_cfg_interconnect/M07_ACLK


# connect clocks
if {$JESD_MODE == "8B10B"} {
  ad_connect mng_clk /axi_mxfe_rx_xcvr/s_axi_aclk
  ad_connect mng_clk /axi_mxfe_tx_xcvr/s_axi_aclk
} else {
  ad_connect mng_clk /jesd204_phy_121/s_axi_aclk
  ad_connect mng_clk /jesd204_phy_126/s_axi_aclk
  ad_connect  $sys_cpu_clk jesd204_phy_121/drpclk
  ad_connect  $sys_cpu_clk jesd204_phy_126/drpclk
}

ad_connect mng_clk /rx_mxfe_tpl_core/s_axi_aclk
ad_connect mng_clk /tx_mxfe_tpl_core/s_axi_aclk
ad_connect mng_clk /axi_mxfe_rx_jesd/s_axi_aclk
ad_connect mng_clk /axi_mxfe_tx_jesd/s_axi_aclk
ad_connect mng_clk /axi_mxfe_rx_dma/s_axi_aclk
ad_connect mng_clk /axi_mxfe_tx_dma/s_axi_aclk
ad_connect mng_clk /mng_axi_vip/aclk
ad_connect dma_clk /axi_mxfe_rx_dma/m_dest_axi_aclk
ad_connect dma_clk /axi_mxfe_tx_dma/m_src_axi_aclk

# connect resets
if {$JESD_MODE == "8B10B"} {
  ad_connect mng_rst_n /axi_mxfe_rx_xcvr/s_axi_aresetn
  ad_connect mng_rst_n /axi_mxfe_tx_xcvr/s_axi_aresetn
} else {
  ad_connect mng_rst /jesd204_phy_121/s_axi_aresetn
  ad_connect mng_rst /jesd204_phy_126/s_axi_aresetn
}
ad_connect mng_rst_n /rx_mxfe_tpl_core/s_axi_aresetn
ad_connect mng_rst_n /tx_mxfe_tpl_core/s_axi_aresetn
ad_connect mng_rst_n /axi_mxfe_rx_jesd/s_axi_aresetn
ad_connect mng_rst_n /axi_mxfe_tx_jesd/s_axi_aresetn
ad_connect mng_rst_n /axi_mxfe_rx_dma/s_axi_aresetn
ad_connect mng_rst_n /axi_mxfe_tx_dma/s_axi_aresetn
...
ad_connect /axi_mxfe_rx_dma/m_dest_axi axi_ddr_interconnect/S00_AXI
ad_connect /axi_mxfe_tx_dma/m_src_axi axi_ddr_interconnect/S01_AXI
...
set_property offset 0x00000000 [get_bd_addr_segs {axi_mxfe_rx_dma/m_dest_axi/SEG_ddr_axi_vip_Reg}]
set_property range 4G [get_bd_addr_segs {axi_mxfe_rx_dma/m_dest_axi/SEG_ddr_axi_vip_Reg}]
set_property offset 0x00000000 [get_bd_addr_segs {axi_mxfe_tx_dma/m_src_axi/SEG_ddr_axi_vip_Reg}]
set_property range 4G [get_bd_addr_segs {axi_mxfe_tx_dma/m_src_axi/SEG_ddr_axi_vip_Reg}]


# assign fixed addresses

delete_bd_objs\
  [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_rx_axi_axi_lite]\
  [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_tx_axi_axi_lite]\
  [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_adc_tpl_core_axi_lite]\
  [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_dac_tpl_core_axi_lite]\
  [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_axi_mxfe_rx_dma_axi_lite]\
  [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_axi_mxfe_tx_dma_axi_lite]

if {$ADI_PHY_SEL == 0} {
  delete_bd_objs\
    [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_jesd204_phy_121_Reg]\
    [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_jesd204_phy_126_Reg]

  assign_bd_address [get_bd_addr_segs {jesd204_phy_121/s_axi/Reg }]
  set_property offset 0x44a60000 [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_jesd204_phy_121_Reg}]

  assign_bd_address [get_bd_addr_segs {jesd204_phy_126/s_axi/Reg }]
  set_property offset 0x44b60000  [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_jesd204_phy_126_Reg]
} else {
  delete_bd_objs\
    [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_axi_mxfe_rx_xcvr_axi_lite]\
    [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_axi_mxfe_tx_xcvr_axi_lite]

  assign_bd_address [get_bd_addr_segs {axi_mxfe_rx_xcvr/s_axi/axi_lite }]
  set_property offset 0x44a60000 [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_axi_mxfe_rx_xcvr_axi_lite}]
  assign_bd_address [get_bd_addr_segs {axi_mxfe_tx_xcvr/s_axi/axi_lite }]
  set_property offset 0x44b60000 [get_bd_addr_segs {mng_axi_vip/Master_AXI/SEG_axi_mxfe_tx_xcvr_axi_lite}]
}

assign_bd_address [get_bd_addr_segs {axi_mxfe_rx_jesd/rx_axi/s_axi/axi_lite}]
set_property offset 0x44a90000 [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_rx_axi_axi_lite]

assign_bd_address [get_bd_addr_segs {axi_mxfe_tx_jesd/tx_axi/s_axi/axi_lite}]
set_property offset 0x44b90000 [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_tx_axi_axi_lite]

assign_bd_address [get_bd_addr_segs {rx_mxfe_tpl_core/adc_tpl_core/s_axi/axi_lite}]
set_property offset 0x44a10000 [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_adc_tpl_core_axi_lite]

assign_bd_address [get_bd_addr_segs {tx_mxfe_tpl_core/dac_tpl_core/s_axi/axi_lite}]
set_property offset 0x44b10000 [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_dac_tpl_core_axi_lite]

assign_bd_address [get_bd_addr_segs {axi_mxfe_rx_dma/s_axi/axi_lite}]
set_property offset 0x7c420000 [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_axi_mxfe_rx_dma_axi_lite]

assign_bd_address [get_bd_addr_segs {axi_mxfe_tx_dma/s_axi/axi_lite}]
set_property offset 0x7c430000 [get_bd_addr_segs mng_axi_vip/Master_AXI/SEG_axi_mxfe_tx_dma_axi_lite]
