...
ad_ip_create avl_data_offload {Analog Devices Data Offload}
...
proc data_offload_compose {} {
  ...
  set_instance_parameter_value i_data_offload {MEM_SIZE_LOG2} [$mem_size]
  ...
  set_interface_property init_req EXPORT_OF i_data_offload.init_req

  add_interface sync_ext conduit end
  set_interface_property sync_ext EXPORT_OF i_data_offload.sync_ext
  ...
  add_connection storage_unit.s_axis i_data_offload.m_storage_axis
  ...
  add_connection storage_unit.s_axis_aclk s_axis_clock.clk
  add_connection storage_unit.s_axis_aresetn s_axis_clock.clk_reset
  add_connection storage_unit.m_axis_aclk m_axis_clock.clk
  add_connection storage_unit.m_axis_aresetn m_axis_clock.clk_reset

  add_connection sys_clock.clk i_data_offload.s_axi_aclk
  add_connection sys_clock.clk_reset i_data_offload.s_axi_aresetn
  add_connection s_axis_clock.clk i_data_offload.s_axis_aclk
  add_connection s_axis_clock.clk_reset i_data_offload.s_axis_aresetn
  add_connection m_axis_clock.clk i_data_offload.m_axis_aclk
  add_connection m_axis_clock.clk_reset i_data_offload.m_axis_aresetn
