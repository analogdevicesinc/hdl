...
ad_ip_create jesd204_h_tile_adapter_rx "ADI JESD204C H-Tile PHY Adapter RX"
...
ad_ip_files jesd204_h_tile_adapter_rx [list \
  $ad_hdl_dir/library/util_cdc/sync_bits.v \
  $ad_hdl_dir/library/jesd204/jesd204_common/sync_header_align.v \
  jesd204_h_tile_adapter_rx.v \
  jesd204_h_tile_adapter_rx_constr.sdc \
]
...
add_interface_port phy_rx_parallel_data i_phy_data raw_data Input 64

add_interface phy_rx_control conduit end
add_interface_port phy_rx_control i_phy_control rx_control Input 2

add_interface phy_rx_enh_data_valid conduit end
add_interface_port phy_rx_enh_data_valid i_phy_data_valid rx_enh_data_valid Input 1

add_interface phy_rx_bitslip conduit end
add_interface_port phy_rx_bitslip i_phy_bitslip rx_bitslip Output 1
