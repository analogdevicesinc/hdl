...
set_property -dict [list CONFIG.C_PROBE11_WIDTH {18}] [get_ips my_ila]
set_property -dict [list CONFIG.C_PROBE12_WIDTH {9}] [get_ips my_ila]
set_property -dict [list CONFIG.C_PROBE13_WIDTH {9}] [get_ips my_ila]
