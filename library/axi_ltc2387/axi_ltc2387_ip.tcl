...
set_property -dict [list CONFIG.C_EN_STRG_QUAL {1}] [get_ips my_ila]
set_property -dict [list CONFIG.C_NUM_OF_PROBES {11}] [get_ips my_ila]
...
set_property -dict [list CONFIG.C_ADV_TRIGGER {true}] [get_ips my_ila]
...
set_property -dict [list CONFIG.C_PROBE2_WIDTH {3}] [get_ips my_ila]
...
set_property -dict [list CONFIG.C_PROBE7_WIDTH {18}] [get_ips my_ila]
set_property -dict [list CONFIG.C_PROBE8_WIDTH {9}] [get_ips my_ila]
