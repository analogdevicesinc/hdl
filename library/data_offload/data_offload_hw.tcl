...
ad_interface signal init_req input 1
...
add_interface_port m_axis  m_axis_data  tdata  Output DEST_DATA_WIDTH
add_interface_port m_axis  m_axis_keep  tkeep  Output DEST_DATA_WIDTH/8
...
add_interface_port s_storage_axis  s_storage_axis_data  tdata  Input  DEST_DATA_WIDTH
add_interface_port s_storage_axis  s_storage_axis_keep  tkeep  Input  DEST_DATA_WIDTH/8
...
ad_interface signal wr_request_enable           request_enable           Output 1
ad_interface signal wr_request_valid            request_valid            Output 1
ad_interface signal wr_request_ready            request_ready            Input  1
ad_interface signal wr_request_length           request_length           Output MEM_SIZE_LOG2
ad_interface signal wr_response_measured_length response_measured_length Input  MEM_SIZE_LOG2
ad_interface signal wr_response_eot             response_eot             Input  1
ad_interface signal wr_overflow                 status_overflow          Input  1

ad_interface signal rd_request_enable           request_enable           Output 1
ad_interface signal rd_request_valid            request_valid            Output 1
ad_interface signal rd_request_ready            request_ready            Input  1
ad_interface signal rd_request_length           request_length           Output MEM_SIZE_LOG2
ad_interface signal rd_response_eot             response_eot             Input  1
ad_interface signal rd_underflow                status_underflow         Input  1
