...
adi_ip_create axi_fsrc_sequencer
adi_ip_files axi_fsrc_sequencer [list \
...
adi_ip_properties axi_fsrc_sequencer
adi_ip_ttcl fsrc_tx "axi_fsrc_sequencer_constr.ttcl"
set_property display_name "ADI AXI FSRC SEQUENCER" [ipx::current_core]
set_property description "ADI AXI FSRC SEQUENCER" [ipx::current_core]
# set_property company_url {https://wiki.analog.com/resources/fpga/docs/axi_fsrc_sequencer} [ipx::current_core]
