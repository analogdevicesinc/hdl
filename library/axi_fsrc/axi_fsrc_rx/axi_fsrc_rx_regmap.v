...
//   0x4  RW  [0] enable
//
// One map serves every converter: the invalid sample slots are the same on all
// of them, so there is nothing to enable per converter.

module axi_fsrc_rx_regmap #(
  parameter ID = 0,
