...
set_module_property NAME util_rfifo
set_module_property DESCRIPTION "Utils Read FIFO"
set_module_property VERSION 1.0
set_module_property GROUP "Analog Devices"
set_module_property DISPLAY_NAME util_rfifo
set_module_property ELABORATION_CALLBACK p_util_rfifo
...
ad_alt_intf reset-n din_rstn        input   1 if_din_clk

ad_alt_intf clock   dout_clk        input   1
ad_alt_intf reset   dout_rst        input   1 if_dout_clk
...
proc p_util_rfifo {} {
  ...
  if {[get_parameter_value NUM_OF_CHANNELS] > 1} {
    ...
    add_interface_port din_1  din_enable_1  enable   Output 1
    add_interface_port din_1  din_valid_1   valid    Output 1
    ...
    add_interface_port dout_1 dout_valid_1  valid    Input  1
  ...
  if {[get_parameter_value NUM_OF_CHANNELS] > 2} {
    ...
    add_interface_port din_2  din_enable_2  enable   Output 1
    add_interface_port din_2  din_valid_2   valid    Output 1
    ...
    add_interface_port dout_2 dout_valid_2  valid    Input  1
  ...
  if {[get_parameter_value NUM_OF_CHANNELS] > 3} {
    ...
    add_interface_port din_3  din_enable_3  enable   Output 1
    add_interface_port din_3  din_valid_3   valid    Output 1
    ...
    add_interface_port dout_3 dout_valid_3  valid    Input  1
  ...
  if {[get_parameter_value NUM_OF_CHANNELS] > 4} {
    ...
    add_interface_port din_4  din_enable_4  enable   Output 1
    add_interface_port din_4  din_valid_4   valid    Output 1
    ...
    add_interface_port dout_4 dout_valid_4  valid    Input  1
  ...
  if {[get_parameter_value NUM_OF_CHANNELS] > 5} {
    ...
    add_interface_port din_5  din_enable_5  enable   Output 1
    add_interface_port din_5  din_valid_5   valid    Output 1
    ...
    add_interface_port dout_5 dout_valid_5  valid    Input  1
  ...
  if {[get_parameter_value NUM_OF_CHANNELS] > 6} {
    ...
    add_interface_port din_6  din_enable_6  enable   Output 1
    add_interface_port din_6  din_valid_6   valid    Output 1
    ...
    add_interface_port dout_6 dout_valid_6  valid    Input  1
  ...
  if {[get_parameter_value NUM_OF_CHANNELS] > 7} {
    ...
    add_interface_port din_7  din_enable_7  enable   Output 1
    add_interface_port din_7  din_valid_7   valid    Output 1
    ...
    add_interface_port dout_7 dout_valid_7  valid    Input  1
