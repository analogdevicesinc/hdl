proc i3c_controller_create {{name "i3c_controller"} {async_i3c_clk 1}} {
  ...
  ad_ip_instance i3c_controller_host_core core
  ...
  ad_connect axi_regmap/i3c_resetn host_interface/resetn
  ad_connect axi_regmap/i3c_resetn core/resetn
