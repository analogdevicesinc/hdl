...
module axi_pwm_gen #(
  ...
  generate
    ...
    if (EXT_SYNC_PHASE_ALIGN == 1) begin
      assign new_alignment = load_config_s | ext_sync_s;
    end else begin
      assign new_alignment = load_config_s;
    end
  endgenerate
