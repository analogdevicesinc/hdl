...
//  wire  [(DATA_WIDTH-1):0]      data_in_idelay_s_frame;
      ...
      for (l_inst = 0; l_inst <= (DATA_WIDTH-1); l_inst = l_inst + 1) begin: g_data
        ...
        if (IODELAY_ENABLE == 1) begin
          ...
          IDELAYE2 #(
            ...
            .C (up_clk),
            .IDATAIN (data_in_s),
            .DATAOUT (data_in_idelay_s_frame),
            .LD (up_dld),
            .CNTVALUEIN (up_dwdata[DRP_WIDTH +: DRP_WIDTH]),
            .CNTVALUEOUT (up_drdata[DRP_WIDTH +: DRP_WIDTH]));
        end
