...
proc create_xcvr_subsystem {
  ...
  # set_property CONFIG.INTF0_GT_SETTINGS(LR0_SETTINGS) {RX_LINE_RATE 10 RX_REFCLK_FREQUENCY 250 RX_USER_DATA_WIDTH 40 TXPROGDIV_FREQ_VAL 250.000 TX_LINE_RATE 10 TX_REFCLK_FREQUENCY 250 TX_USER_DATA_WIDTH 40 RXPROGDIV_FREQ_VAL 500.000} [get_bd_cells gtwiz_versal_0]
...
proc create_versal_jesd_xcvr_subsystem {
  ...
  if {$intf_cfg != "TX"} {
    ...
    if {$transceiver != "GTM" || $link_mode == 1} {
    ...
    for {set j 0} {$j < $rx_no_lanes} {incr j} {
      ...
      if {$transceiver != "GTM" || $link_mode == 1} {
        ad_connect ${ip_name}/xcvr/INTF${rx_intf}_rx_usrclk ${ip_name}/rx_adapt_${j}/usr_clk
        ad_connect ${ip_name}/xcvr/INTF${rx_intf}_rx_usrclk ${ip_name}/rx_adapt_${j}/phy_clk
        ad_connect ${ip_name}/xcvr/INTF${rx_intf}_rst_rx_done_out ${ip_name}/rx_adapt_${j}/phy_rstn
      } else {
        ad_connect ${ip_name}/bufg_gt_rx/usrclk ${ip_name}/rx_adapt_${j}/phy_clk
        if {$external_link_clk} {
          ad_connect ${ip_name}/rx_usrclk_in ${ip_name}/rx_adapt_${j}/usr_clk
          ad_connect ${ip_name}/xcvr/INTF${rx_intf}_rst_rx_done_out ${ip_name}/rx_adapt_${j}/phy_rstn
        } else {
          ad_connect ${ip_name}/rx_clkwiz/clk_out1 ${ip_name}/rx_adapt_${j}/usr_clk
          ad_connect ${ip_name}/rx_clkwiz/locked ${ip_name}/rx_adapt_${j}/phy_rstn
        }
      }
    }
  }
  ...
  if {$intf_cfg != "RX"} {
    ...
    ad_connect ${ip_name}/xcvr/INTF${tx_intf}_TX_USRCLK  ${ip_name}/bufg_gt_tx/outclk
    if {$transceiver != "GTM" || $link_mode == 1} {
    ...
    for {set j 0} {$j < $tx_no_lanes} {incr j} {
      ...
      if {$transceiver != "GTM" || $link_mode == 1} {
        ad_connect ${ip_name}/xcvr/INTF${tx_intf}_tx_usrclk ${ip_name}/tx_adapt_${j}/usr_clk
        ad_connect ${ip_name}/xcvr/INTF${tx_intf}_tx_usrclk ${ip_name}/tx_adapt_${j}/phy_clk
        ad_connect ${ip_name}/xcvr/INTF${tx_intf}_rst_tx_done_out ${ip_name}/tx_adapt_${j}/phy_rstn
      } else {
        ad_connect ${ip_name}/bufg_gt_tx/usrclk ${ip_name}/tx_adapt_${j}/phy_clk
        if {$external_link_clk} {
          ad_connect ${ip_name}/tx_usrclk_in ${ip_name}/tx_adapt_${j}/usr_clk
          ad_connect ${ip_name}/xcvr/INTF${tx_intf}_rst_tx_done_out ${ip_name}/tx_adapt_${j}/phy_rstn
        } else {
          ad_connect ${ip_name}/tx_clkwiz/clk_out1 ${ip_name}/tx_adapt_${j}/usr_clk
          ad_connect ${ip_name}/tx_clkwiz/locked ${ip_name}/tx_adapt_${j}/phy_rstn
        }
      }
    }
  }
