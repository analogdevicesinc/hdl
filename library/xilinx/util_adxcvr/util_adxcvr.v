...
module util_adxcvr #(
  ...
  parameter          CH_HSPMUX = 16'b0100010001000100,
  parameter          CPLL_CFG0 = 16'b0000001111111110,
  parameter          CPLL_CFG1 = 16'b0000000000100001,
  parameter          CPLL_CFG2 = 16'b0000001000000011,
  parameter          PREIQ_FREQ_BST = 1,
  parameter          PCIE_BUFG_DIV_CTRL = 16'h3500,
  parameter          PCIE_PLL_SEL_MODE_GEN12 = 2'h2,
  parameter          RXCDR_CFG0 = 16'b0000000000000011,
  parameter          RXCDR_CFG2_GEN4 = 16'b0000000101100100,
  parameter          RXCDR_CFG3 = 16'b0000000000011010,
  parameter          RXCDR_CFG3_GEN2 = 6'b011010,
  parameter          RXCDR_CFG3_GEN3 = 16'b0000000000011010,
  parameter          RXCDR_CFG3_GEN4 = 16'b0000000000100100,
  parameter          RXDFE_CFG1 = 16'b0000001010000000,
  parameter          RXPI_CFG0 = 16'b0010000000000100,
  parameter          RXPI_CFG1 = 16'b0000000000000000,
  parameter          RX_WIDEMODE_CDR = 2'b01,
  parameter          TXPH_CFG = 16'h0323,
  parameter          TXPI_CFG = 16'b0000000000000000,
  parameter          TXPI_CFG3 = 1'b1,
  parameter          TXPI_CFG4 = 1'b0,
  parameter          TX_PI_BIASSET = 2'b10,
