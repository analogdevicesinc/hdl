...
module util_adxcvr_xcm #(
  ...
  parameter   [ 9:0]  GTX_QPLL_FBDIV =  10'b0000110000,
  parameter   integer GTX_QPLL_FBDIV_RATIO = 1,
  parameter   [26:0]  GTX_QPLL_CFG = 27'h0680181,

  parameter   [ 9:0]  GTH3_QPLL_FBDIV =  10'b0000110000,
  parameter   integer GTH3_QPLL_FBDIV_G3 = 80,
  parameter   [15:0]  GTH3_QPLL_CFG0 = 16'b0011001100011100,
  parameter   [15:0]  GTH3_QPLL_CFG1 = 16'b1101000000111000,
  parameter   [15:0]  GTH3_QPLL_CFG1_G3 = 16'b1101000000111000,
  parameter   [15:0]  GTH3_QPLL_CFG2 = 16'b0000111111000000,
  parameter   [15:0]  GTH3_QPLL_CFG2_G3 = 16'b0000111111000000,
  parameter   [15:0]  GTH3_QPLL_CFG3 = 16'b0000000100100000,
  parameter   [15:0]  GTH3_QPLL_CFG4 = 16'b0000000000000011,
  parameter   [ 9:0]  GTH3_QPLL_CP = 10'b0000011111,
  parameter   [ 9:0]  GTH3_QPLL_CP_G3 = 10'b1111111111,
  parameter   [ 9:0]  GTH3_QPLL_LPF = 10'b1111111111,
  parameter   [ 9:0]  GTH3_QPLL_LPF_G3 = 10'b0000010101,

  parameter   [ 9:0]  GTH4_QPLL_FBDIV =  10'b0000110000,
  parameter   integer GTH4_QPLL_FBDIV_G3 = 160,
  parameter   [15:0]  GTH4_QPLL_CFG0 = 16'b0011001100011100,
  parameter   [15:0]  GTH4_QPLL_CFG1 = 16'b1101000000111000,
  parameter   [15:0]  GTH4_QPLL_CFG1_G3 = 16'b1101000000111000,
  parameter   [15:0]  GTH4_QPLL_CFG2 = 16'b0000111111000000,
  parameter   [15:0]  GTH4_QPLL_CFG2_G3 = 16'b0000111111000000,
  parameter   [15:0]  GTH4_QPLL_CFG3 = 16'b0000000100100000,
  parameter   [15:0]  GTH4_QPLL_CFG4 = 16'b0000000000000011,
  parameter   [ 9:0]  GTH4_QPLL_CP = 10'b0001111111,
  parameter   [ 9:0]  GTH4_QPLL_CP_G3 = 10'b0000011111,
  parameter   [ 9:0]  GTH4_QPLL_LPF = 10'b0100110111,
  parameter   [ 9:0]  GTH4_QPLL_LPF_G3 = 10'b0111010101
  ...
  GTXE2_COMMON #(
    ...
    .QPLL_FBDIV (GTX_QPLL_FBDIV),
    .QPLL_FBDIV_MONITOR_EN (1'b0),
    .QPLL_FBDIV_RATIO (GTX_QPLL_FBDIV_RATIO),
  ...
  GTHE3_COMMON #(
    ...
    .POR_CFG (16'h0004),
    .QPLL0_CFG0 (GTH3_QPLL_CFG0),
    .QPLL0_CFG1 (GTH3_QPLL_CFG1),
    .QPLL0_CFG1_G3 (GTH3_QPLL_CFG1_G3),
    .QPLL0_CFG2 (GTH3_QPLL_CFG2),
    .QPLL0_CFG2_G3 (GTH3_QPLL_CFG2_G3),
    .QPLL0_CFG3 (GTH3_QPLL_CFG3),
    .QPLL0_CFG4 (GTH3_QPLL_CFG4),
    .QPLL0_CP (GTH3_QPLL_CP),
    .QPLL0_CP_G3 (GTH3_QPLL_CP_G3),
    .QPLL0_FBDIV (GTH3_QPLL_FBDIV),
    .QPLL0_FBDIV_G3 (GTH3_QPLL_FBDIV_G3),
    .QPLL0_INIT_CFG0 (16'h02b2),
    .QPLL0_INIT_CFG1 (8'h00),
    .QPLL0_LOCK_CFG (16'h21e8),
    .QPLL0_LOCK_CFG_G3 (16'h21e8),
    .QPLL0_LPF (GTH3_QPLL_LPF),
    .QPLL0_LPF_G3 (GTH3_QPLL_LPF_G3),
    ...
    .QPLL1_CFG0 (GTH3_QPLL_CFG0),
    .QPLL1_CFG1 (GTH3_QPLL_CFG1),
    .QPLL1_CFG1_G3 (GTH3_QPLL_CFG1_G3),
    .QPLL1_CFG2 (GTH3_QPLL_CFG2),
    .QPLL1_CFG2_G3 (GTH3_QPLL_CFG2_G3),
    .QPLL1_CFG3 (GTH3_QPLL_CFG3),
    .QPLL1_CFG4 (GTH3_QPLL_CFG4),
    .QPLL1_CP (GTH3_QPLL_CP),
    .QPLL1_CP_G3 (GTH3_QPLL_CP_G3),
    .QPLL1_FBDIV (GTH3_QPLL_FBDIV),
    .QPLL1_FBDIV_G3 (GTH3_QPLL_FBDIV_G3),
    .QPLL1_INIT_CFG0 (16'h02b2),
    .QPLL1_INIT_CFG1 (8'h00),
    .QPLL1_LOCK_CFG (16'h21e8),
    .QPLL1_LOCK_CFG_G3 (16'h21e8),
    .QPLL1_LPF (GTH3_QPLL_LPF),
    .QPLL1_LPF_G3 (GTH3_QPLL_LPF_G3),
  ...
  GTHE4_COMMON #(
    ...
    .QPLL0_CFG0 (GTH4_QPLL_CFG0),
    .QPLL0_CFG1 (GTH4_QPLL_CFG1),
    .QPLL0_CFG1_G3 (GTH4_QPLL_CFG1_G3),
    .QPLL0_CFG2 (GTH4_QPLL_CFG2),
    .QPLL0_CFG2_G3 (GTH4_QPLL_CFG2_G3),
    .QPLL0_CFG3 (GTH4_QPLL_CFG3),
    .QPLL0_CFG4 (GTH4_QPLL_CFG4),
    .QPLL0_CP (GTH4_QPLL_CP),
    .QPLL0_CP_G3 (GTH4_QPLL_CP_G3),
    .QPLL0_FBDIV (GTH4_QPLL_FBDIV),
    .QPLL0_FBDIV_G3 (GTH4_QPLL_FBDIV_G3),
    ...
    .QPLL0_LPF (GTH4_QPLL_LPF),
    .QPLL0_LPF_G3 (GTH4_QPLL_LPF_G3),
    .QPLL0_PCI_EN (1'b0),
    ...
    .QPLL1_CFG0 (GTH4_QPLL_CFG0),
    .QPLL1_CFG1 (GTH4_QPLL_CFG1),
    .QPLL1_CFG1_G3 (GTH4_QPLL_CFG1_G3),
    .QPLL1_CFG2 (GTH4_QPLL_CFG2),
    .QPLL1_CFG2_G3 (GTH4_QPLL_CFG2_G3),
    .QPLL1_CFG3 (GTH4_QPLL_CFG3),
    .QPLL1_CFG4 (GTH4_QPLL_CFG4),
    .QPLL1_CP (GTH4_QPLL_CP),
    .QPLL1_CP_G3 (GTH4_QPLL_CP_G3),
    .QPLL1_FBDIV (GTH4_QPLL_FBDIV),
    .QPLL1_FBDIV_G3 (GTH4_QPLL_FBDIV_G3),
    ...
    .QPLL1_LPF (GTH4_QPLL_LPF),
    .QPLL1_LPF_G3 (GTH4_QPLL_LPF_G3),
    .QPLL1_PCI_EN (1'b0),
