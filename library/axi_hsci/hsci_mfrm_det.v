     ...
     if (~rstn)
       ...
       if (frm_det == 1'b0) 
        ...
        //    end
         ...
         begin
         if ( ((auto_linkup == 1'b1) & (frm_acq_cnt != 2'b00)) | (idle_cnt == 3'b100) )
           begin
           frm_det <= 1'b0;
           frm_align <= 4'h9;
           mdec_sfrm <= 10'h000;
           end
         else if ( ( (dec_fsm == DEC_LINKUP) | (dec_fsm == DEC_RDATA) | (dec_fsm == DEC_ERROR) | (dec_fsm == DEC_MERR) ) & (mdec_sfrm[0] == 1'b0) & (mdec_val == 1'b1) )
           begin
