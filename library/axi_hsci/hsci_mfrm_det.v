  ...
  always @ (posedge hsci_pclk or negedge rstn) begin
    if (~rstn) begin
      ...
      if (frm_det == 1'b0) begin
        ...
        // else if(ibuf[15] == 1'b1) begin
        //   frm_det <= 1'b1;
        //   frm_align <= 4'h6;
        //   mdec_sfrm <= tmp_frm[6];
        // end
        else if(ibuf[14] == 1'b1) begin
          frm_det <= 1'b1;
          frm_align <= 4'h5;
          mdec_sfrm <= tmp_frm[5];
        end
        // else if(ibuf[13] == 1'b1) begin
        //   frm_det <= 1'b1;
        //   frm_align <= 4'h4;
        //   mdec_sfrm <= tmp_frm[4];
        // end
        else if(ibuf[12] == 1'b1) begin
          frm_det <= 1'b1;
          frm_align <= 4'h3;
          mdec_sfrm <= tmp_frm[3];
        end
        // else if(ibuf[11] == 1'b1) begin
        //   frm_det <= 1'b1;
        //   frm_align <= 4'h2;
        //   mdec_sfrm <= tmp_frm[2];
        // end
        else if(ibuf[10] == 1'b1) begin
          frm_det <= 1'b1;
          frm_align <= 4'h1;
          mdec_sfrm <= tmp_frm[1];
        end
        // else if(ibuf[9] == 1'b1) begin
        //   frm_det <= 1'b1;
        //   frm_align <= 4'h0;
        //   mdec_sfrm <= tmp_frm[0];
        // end
        ...
        if (((auto_linkup == 1'b1) & (frm_acq_cnt != 2'b00)) | (idle_cnt == 3'b100)) begin
          ...
          case(frm_align)
            ...
            4'h7: begin
              ...
              // else if (tmp_frm[4][9] == 1'b1) begin
              //   frm_det <= 1'b1;
              //   frm_align <= 4'h4;
              //   mdec_sfrm <= tmp_frm[4];
              // end
              else if (tmp_frm[3][9] == 1'b1) begin
                frm_det <= 1'b1;
                frm_align <= 4'h3;
                mdec_sfrm <= tmp_frm[3];
              end
              // else if (tmp_frm[2][9] == 1'b1) begin
              //   frm_det <= 1'b1;
              //   frm_align <= 4'h2;
              //   mdec_sfrm <= tmp_frm[2];
              // end
              else if (tmp_frm[1][9] == 1'b1) begin
                frm_det <= 1'b1;
                frm_align <= 4'h1;
                mdec_sfrm <= tmp_frm[1];
              end
              // else if (tmp_frm[0][9] == 1'b1) begin
              //   frm_det <= 1'b1;
              //   frm_align <= 4'h0;
              //   mdec_sfrm <= tmp_frm[0];
              // end
              else begin // drop frm_det
                frm_det <= 1'b0;
                frm_align <= 4'h9;
                mdec_sfrm <= 10'h000;
