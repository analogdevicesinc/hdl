...
ad_interface signal wr_request_enable           request_enable           Input  1
ad_interface signal wr_request_valid            request_valid            Input  1
ad_interface signal wr_request_ready            request_ready            Output 1
ad_interface signal wr_request_length           request_length           Input  LENGTH_WIDTH
ad_interface signal wr_response_measured_length response_measured_length Output LENGTH_WIDTH
ad_interface signal wr_response_eot             response_eot             Output 1

ad_interface signal rd_request_enable           request_enable           Input  1
ad_interface signal rd_request_valid            request_valid            Input  1
ad_interface signal rd_request_ready            request_ready            Output 1
ad_interface signal rd_request_length           request_length           Input  LENGTH_WIDTH
ad_interface signal rd_response_eot             response_eot             Output 1
