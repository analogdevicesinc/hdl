...
add_fileset_file util_wfifo_constr.sdc  SDC     PATH util_wfifo_constr.xdc
...
set_interface_property din_0 associatedReset if_din_rst
...
set_interface_property dout_0 associatedReset if_dout_rstn
...
proc p_util_wfifo {} {
  ...
  if {[get_parameter_value NUM_OF_CHANNELS] > 1} {
    ...
    set_interface_property din_1 associatedReset if_din_rst
    ...
    set_interface_property dout_1 associatedReset if_dout_rstn
  }
  ...
  if {[get_parameter_value NUM_OF_CHANNELS] > 2} {
    ...
    set_interface_property din_2 associatedReset if_din_rst
    ...
    set_interface_property dout_2 associatedReset if_dout_rstn
  }
  ...
  if {[get_parameter_value NUM_OF_CHANNELS] > 3} {
    ...
    set_interface_property din_3 associatedReset if_din_rst
    ...
    set_interface_property dout_3 associatedReset if_dout_rstn
  }
  ...
  if {[get_parameter_value NUM_OF_CHANNELS] > 4} {
    ...
    set_interface_property din_4 associatedReset if_din_rst
    ...
    set_interface_property dout_4 associatedReset if_dout_rstn
  }
  ...
  if {[get_parameter_value NUM_OF_CHANNELS] > 5} {
    ...
    set_interface_property din_5 associatedReset if_din_rst
    ...
    set_interface_property dout_5 associatedReset if_dout_rstn
  }
  ...
  if {[get_parameter_value NUM_OF_CHANNELS] > 6} {
    ...
    set_interface_property din_6 associatedReset if_din_rst
    ...
    set_interface_property dout_6 associatedReset if_dout_rstn
  }
  ...
  if {[get_parameter_value NUM_OF_CHANNELS] > 7} {
    ...
    set_interface_property din_7 associatedReset if_din_rst
    ...
    set_interface_property dout_7 associatedReset if_dout_rstn
  }
