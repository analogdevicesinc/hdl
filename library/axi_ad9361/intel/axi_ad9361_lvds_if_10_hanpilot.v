...
module axi_ad9361_lvds_if_10_hanpilot  #(
  ...
  always @(posedge clk) begin
    locked_int <= locked_s & locked_s_3f & (& rx_data_locked_s) &
      (& rx_delay_locked_s);
  end
  ...
  for (i = 0; i < 6; i = i + 1) begin: g_rx_data
    if (RX_NODPA == 0) begin
      ...
      if ((i == 0) || (i == 2)) begin
        axi_ad9361_serdes_in i_rx_data (
          .data_in_export (rx_data_in_p[i]),
          .clk_export (lvds_clk_3f),
          .loaden_export (lvds_loaden_3f),
          .div_clk_export (clk_3f),
          .data_s_export (rx_data_s[((i*4)+3):(i*4)]));
      end else begin
        axi_ad9361_serdes_in i_rx_data (
          .data_in_export (rx_data_in_p[i]),
  ...
  axi_ad9361_serdes_clk i_clk1 (
    .rst_reset (pll_rst),
    .ref_clk_clk (rx_clk),
    .locked_export (locked_s_3f),
    .hs_phase_phout (lvds_phase_3f),
    .hs_clk_lvds_clk (lvds_clk_3f),
    .loaden_loaden (lvds_loaden_3f),
    .ls_clk_clk (clk_3f));
