...
module axi_adrv9001_sync_ctrl #(
  ...
  localparam MCS_SYNC_PULSE_WIDTH = DEFAULT_REF_CLK / 9; // > 100 us (3413)
  localparam MCS_SYNC_PULSE_DELAY = DEFAULT_REF_CLK / 9; // > 100 us
  ...
  up_xfer_status #(
    ...
    .up_data_status ({up_rx1_mcs_to_strobe_delay,
                      up_rx2_mcs_to_strobe_delay}),
    .d_rst (ref_rst_s),
    .d_clk (ref_clk),
    .d_data_status ({ rx1_mcs_to_strobe_delay,
                      rx2_mcs_to_strobe_delay}));
  ...
  up_xfer_cntrl #(
    ...
    .d_data_cntrl({
                   sync_config,
                   mcs_sync_pulse_width,
                   mcs_sync_pulse_1_delay,
                   mcs_sync_pulse_2_delay,
                   mcs_sync_pulse_3_delay,
                   mcs_sync_pulse_4_delay,
                   mcs_sync_pulse_5_delay,
                   mcs_sync_pulse_6_delay}));
