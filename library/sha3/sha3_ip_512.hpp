...
//(6 * NUM_MSG)
//ideal NUM_WORKERS == (num_cycles for processing a single block) / (BLOCK_SIZE * NUM_BLOCKS)
//in our case, 3963/792 = 5.003. So we need 6 * NUM_MSG replications to avoid stalls
