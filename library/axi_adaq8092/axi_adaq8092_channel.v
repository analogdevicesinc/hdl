...
module axi_adaq8092_channel #(
  ...
  output      [27:0]      adc_dcfilter_data_out,
  output                  adc_valid,
  output                  adc_enable,
  ...
  wire    [27:0]  adc_dfmt_data_s;
  wire            adc_dcfilt_enb_s;
  wire            adc_dfmt_se_s;
  wire            adc_dfmt_type_s;
  wire            adc_dfmt_enable_s;
  wire    [27:0]  adc_dcfilt_offset_s;
  wire    [27:0]  adc_dcfilt_coeff_s;
  ...
  ad_datafmt #(.DATA_WIDTH(28)) i_ad_datafmt (
    .clk (adc_clk),
    .valid (1'b1),
    .data (adc_data),
    .valid_out (),
