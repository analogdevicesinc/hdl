...
module axi_dmac_regmap_request #(
  ...
  input request_ready,
  output [31:BYTES_PER_BEAT_WIDTH_DEST] request_dest_address,
  output [31:BYTES_PER_BEAT_WIDTH_SRC] request_src_address,
...
assign request_xlast = up_dma_xlast;
...
begin
  ...
  9'h103: up_rdata <= {30'h00, up_dma_xlast, up_dma_cyclic}; // Flags
