...
proc spi_engine_create {args} {
  ...
  if {$vendor == "xilinx"} {
    ...
    set num_cs                [optional_param $args 3 1]
    set num_sdi               [optional_param $args 4 1]
    set num_sdo               [optional_param $args 5 1]
    set sdi_delay             [optional_param $args 6 0]
    set echo_sclk             [optional_param $args 7 0]
    set sdo_streaming         [optional_param $args 8 0]
    set cmd_mem_addr_width    [optional_param $args 9 4]
    set data_mem_addr_width   [optional_param $args 10 4]
    set sdi_fifo_addr_width   [optional_param $args 11 5]
    set sdo_fifo_addr_width   [optional_param $args 12 5]
    set sync_fifo_addr_width  [optional_param $args 13 4]
    set cmd_fifo_addr_width   [optional_param $args 14 4]
    ...
    set num_cs                [optional_param $args 6 1]
    set num_sdi               [optional_param $args 7 1]
    set num_sdo               [optional_param $args 8 1]
    set sdi_delay             [optional_param $args 9 0]
    set echo_sclk             [optional_param $args 10 0]
    set sdo_streaming         [optional_param $args 11 0]
    set cmd_mem_addr_width    [optional_param $args 12 4]
    set data_mem_addr_width   [optional_param $args 13 4]
    set sdi_fifo_addr_width   [optional_param $args 14 5]
    set sdo_fifo_addr_width   [optional_param $args 15 5]
    set sync_fifo_addr_width  [optional_param $args 16 4]
    set cmd_fifo_addr_width   [optional_param $args 17 4]
  }
