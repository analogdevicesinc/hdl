...
assign data_out = (cfg_disable_char_replacement || !cfg_disable_scrambler || ~ENABLED) ? data : data_replaced;
assign charisk_out = (IS_RX || !cfg_disable_scrambler || cfg_disable_char_replacement || ~ENABLED) ? 'b0 : char_is_align;
