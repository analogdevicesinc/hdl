...
adi_if_infer_bus analog.com:interface:if_i2c master i2c [list \
  ...
  ipx::infer_bus_interface sfp_tx_clk_int xilinx.com:signal:clock_rtl:1.0 [ipx::current_core]
  ipx::infer_bus_interface sfp_rx_clk_int xilinx.com:signal:clock_rtl:1.0 [ipx::current_core]
