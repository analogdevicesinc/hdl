...
ipgui::add_param -name "QSFP_CNT" -component $cc -parent $page0
set p [ipgui::get_guiparamspec -name "QSFP_CNT" -component $cc]
ipgui::move_param -component $cc -order 0 $p -parent $group
set_property  -dict [list \
  "display_name" "QSFP connector count" \
] $p
...
ipgui::add_param -name "PORT_COUNT" -component $cc -parent $page0
