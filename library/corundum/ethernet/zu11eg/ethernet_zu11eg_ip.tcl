...
adi_ip_create ethernet_zu11eg

set_property part xczu11eg-ffvf1517-2-i [current_project]

source "cmac_usplus.tcl"
source "eth_xcvr_gth.tcl"

# Corundum sources
adi_ip_files ethernet_zu11eg [list \
  "ethernet_zu11eg.v" \
  "eth_xcvr_phy_100g_gth_wrapper.v" \
  "eth_xcvr_phy_100g_gth_quad_wrapper.v" \
...
adi_ip_properties_lite ethernet_zu11eg

set cc [ipx::current_core]

set_property display_name "Corundum Ethernet ZU11EG" $cc
set_property description "Corundum Ethernet Core IP" $cc
set_property company_url {https://analogdevicesinc.github.io/hdl/library/corundum/ethernet/ethernet_zu11eg} [ipx::current_core]
