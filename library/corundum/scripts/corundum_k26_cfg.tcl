...
set RAM_SEL_WIDTH 3
set RAM_SEG_COUNT 2
set RAM_SEG_DATA_WIDTH 128
set RAM_SEG_BE_WIDTH 16
set RAM_SEG_ADDR_WIDTH 10
set AXIS_SYNC_KEEP_WIDTH 8
set AXIS_SYNC_TX_USER_WIDTH 7
set AXIS_SYNC_RX_USER_WIDTH 64
set AXIS_IF_KEEP_WIDTH 8
set AXIS_IF_TX_ID_WIDTH 5 
set AXIS_IF_RX_ID_WIDTH 1
set AXIS_IF_TX_DEST_WIDTH 4
set AXIS_IF_RX_DEST_WIDTH 6
set AXIS_IF_TX_USER_WIDTH 7
set AXIS_IF_RX_USER_WIDTH 64
