...
adi_ip_files application_core [list \
  "application_core.v" \
  "$ad_hdl_dir/../corundum/fpga/lib/axi/rtl/axil_ram.v" ]
...
set_property description "Application Core IP" $cc
...
adi_add_bus "input_axis" "slave" \
  ...
  "xilinx.com:interface:axis:1.0" \
  {
    {"s_axis_tdata_res" "TDATA"} \
    {"s_axis_tkeep_res" "TKEEP"} \
    {"s_axis_tvalid_res" "TVALID"} \
    {"s_axis_tready_out" "TREADY"} \
    {"s_axis_tlast_res" "TLAST"} \
    {"s_axis_tuser_res" "TUSER"} \
  }
...
adi_add_bus "output_axis" "master" \
  ...
  "xilinx.com:interface:axis:1.0" \
  {
    {"m_axis_tdata_out" "TDATA"} \
    {"m_axis_tkeep_out" "TKEEP"} \
    {"m_axis_tvalid_out" "TVALID"} \
    {"m_axis_tready_res" "TREADY"} \
    {"m_axis_tlast_out" "TLAST"} \
    {"m_axis_tuser_out" "TUSER"} \
  }

# Bus-clock association

adi_add_bus_clock "clk" "s_axil_ctrl:s_axis_sync_tx:m_axis_sync_tx:s_axis_sync_rx:m_axis_sync_rx:s_axis_if_tx:m_axis_if_tx:s_axis_if_rx:m_axis_if_rx:m_axil_ctrl:input_axis:output_axis" "rst"
