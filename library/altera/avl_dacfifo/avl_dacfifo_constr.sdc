...
set_false_path  -from [get_registers *avl_dacfifo_rd:i_rd|avl_xfer_req*]            \
...
set_false_path  -from [get_registers *util_dacfifo_bypass:i_dacfifo_bypass|dma_xfer_req*]       \
                -to [get_registers *util_dacfifo_bypass:i_dacfifo_bypass|dac_xfer_out_m1*]

set_false_path  -from [get_registers *avl_dacfifo:*bypass*]                                     \
                -to [get_registers *avl_dacfifo:*bypass_m1*]
