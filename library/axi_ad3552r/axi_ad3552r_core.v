...
module axi_ad3552r_core #(
  ...
  assign address         = dac_data_control[15:8];
  assign control_valid   = dac_data_control[16];
  assign sdr_ddr_n       = dac_control[0];
  assign write_start     = dac_control[1];
  assign write_stop      = dac_control[2];
