...
module axi_ad7768_if #(
  ...
  always @(posedge adc_clk) begin
    if (adc_valid_p == 1'b1) begin
      ...
      end else if(adc_format == 'h2 || (adc_format == 'h1 && NUM_CHANNELS == 4)) begin   // 2 active lines or 1 for ad7768-4
  ...
  always @(negedge adc_clk) begin
    ...
    end else if(adc_format == 'h2 || (adc_format == 'h1 && NUM_CHANNELS == 4)) begin  // 2 active lines or 1 active lane for ad7768-4
      if (adc_cnt_p == 'h0) begin
