...
module axi_ad7606x #(
  ...
  if (DEV_CONFIG == 0 || DEV_CONFIG == 1) begin
    assign adc_data_0[15:0] = 16'b0;
    assign adc_data_1[15:0] = 16'b0;
    assign adc_data_2[15:0] = 16'b0;
    assign adc_data_3[15:0] = 16'b0;
    assign adc_data_4[15:0] = 16'b0;
    assign adc_data_5[15:0] = 16'b0;
    assign adc_data_6[15:0] = 16'b0;
    assign adc_data_7[15:0] = 16'b0;
  end else begin
    assign adc_data_0[13:0] = 14'b0;
    assign adc_data_1[13:0] = 14'b0;
    assign adc_data_2[13:0] = 14'b0;
    assign adc_data_3[13:0] = 14'b0;
    assign adc_data_4[13:0] = 14'b0;
    assign adc_data_5[13:0] = 14'b0;
    assign adc_data_6[13:0] = 14'b0;
    assign adc_data_7[13:0] = 14'b0;
  end
  ...
  generate
    if ((DEV_CONFIG == 0) || (DEV_CONFIG == 1)) begin
      ...
      axi_ad7606x_18b_pif #(
        ...
        .busy (rx_busy),
        .first_data (first_data),
        .adc_data_0 (adc_data_0[31:14]),
        .adc_status_0 (adc_status_header[0]),
        .adc_data_1 (adc_data_1[31:14]),
        .adc_status_1 (adc_status_header[1]),
        .adc_data_2 (adc_data_2[31:14]),
        .adc_status_2 (adc_status_header[2]),
        .adc_data_3 (adc_data_3[31:14]),
        .adc_status_3 (adc_status_header[3]),
        .adc_data_4 (adc_data_4[31:14]),
        .adc_status_4 (adc_status_header[4]),
        .adc_data_5 (adc_data_5[31:14]),
        .adc_status_5 (adc_status_header[5]),
        .adc_data_6 (adc_data_6[31:14]),
        .adc_status_6 (adc_status_header[6]),
        .adc_data_7 (adc_data_7[31:14]),
        .adc_status_7 (adc_status_header[7]),
        .adc_status (adc_status),
        .adc_crc (adc_crc),
        .adc_crc_res (adc_crc_res),
