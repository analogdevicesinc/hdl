...
proc init {cellpath otherInfo} {
	...
	bd::mark_propagate_overrideable $ip \
		"ASYNC_CLK DATA_WIDTH TLAST_EN TKEEP_EN TSTRB_EN TUSER_EN TID_EN TDEST_EN TUSER_WIDTH TID_WIDTH TDEST_WIDTH"
...
proc parameter_set {cellpath} {
	...
	if {$pin_source != {}} {
		...
		set_property "CONFIG.DATA_WIDTH" [expr $data_width + 1] $ip
	}

	if {[get_property "CONFIG.TUSER_EN" $ip] == "true"} {
