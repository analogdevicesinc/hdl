...
adi_set_ports_dependency "m_axis_empty" \
	"(spirit:decode(id('MODELPARAM_VALUE.ADDRESS_WIDTH')) != 0)"
adi_set_ports_dependency "m_axis_almost_empty" \
	"(spirit:decode(id('MODELPARAM_VALUE.ADDRESS_WIDTH')) != 0)"
adi_set_ports_dependency "m_axis_full" \
	"(spirit:decode(id('MODELPARAM_VALUE.ADDRESS_WIDTH')) != 0)"
adi_set_ports_dependency "m_axis_almost_full" \
	"(spirit:decode(id('MODELPARAM_VALUE.ADDRESS_WIDTH')) != 0)"

adi_set_ports_dependency "s_axis_empty" \
	"(spirit:decode(id('MODELPARAM_VALUE.ADDRESS_WIDTH')) != 0)"
adi_set_ports_dependency "s_axis_almost_empty" \
	"(spirit:decode(id('MODELPARAM_VALUE.ADDRESS_WIDTH')) != 0)"
adi_set_ports_dependency "s_axis_full" \
	"(spirit:decode(id('MODELPARAM_VALUE.ADDRESS_WIDTH')) != 0)"
adi_set_ports_dependency "s_axis_almost_full" \
	"(spirit:decode(id('MODELPARAM_VALUE.ADDRESS_WIDTH')) != 0)"

adi_set_ports_dependency "m_axis_level" \
	"(spirit:decode(id('MODELPARAM_VALUE.ADDRESS_WIDTH')) != 0)"
adi_set_ports_dependency "s_axis_room" \
	"(spirit:decode(id('MODELPARAM_VALUE.ADDRESS_WIDTH')) != 0)"
