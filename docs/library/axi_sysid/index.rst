...
project is targeting. Data converted from ASCII to hex. Size: 32 Bytes. System
Custom String Area This area provides a region where a custom string supplied by
the user will be written to. This will be stored in ROM1, inside the system bit.
Data converted from ASCII to hex. Size: Variable, 32 Bytes default.
