...
interface the the ADRV9001 family as in:
...
Regarding the DAC, more information related to its generic
...
* :git-hdl:`Wrapper <library/axi_adrv9001/axi_adrv9001.v>` top module
  ...
  * :git-hdl:`Interface <library/axi_adrv9001/axi_adrv9001_if.v>` interface module
  ...
  * :git-hdl:`TPL (core) <library/axi_adrv9001/axi_adrv9001_core>` core module, which contains:

    * :git-hdl:`Receive <library/axi_adrv9001/axi_adrv9001_rx.v>` common receive module, which contains:
...
.. note::
  ...
  signals. To simplify we will look only at the data part:
