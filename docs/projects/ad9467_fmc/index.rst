...
-  :adi:`AD9467-FMC-250EBZ <EVAL-AD9467>` also referred to as
   EVAL-AD9467
...
If that occurs try setting the "capture select" bit (register 0x0a, bit
0).
...
`AD9517 <adi>media/en/technical-documentation/data-sheets/AD9517-4.pdf>`__.
...
-  The schematic of the board cand be found
   :dokuwiki:`here <resources/fpga/xilinx/fmc/9467fmc01c_sch.pdf>`
   or :dokuwiki:`here <resources/fpga/xilinx/fmc/02-041710-01-c-1.pdf>`,
   for older versions.
