...
.. collapsible:: Default values of the ``make`` parameters for AD9081-FMCA-EBZ
   ...
   |                   +----------+----------+--------+--------+--------+-------+--------+
   |                   |   A10SoC |     FM87 | VCK190 | VCU118 | VCU128 | ZC706 | ZCU102 |
   +===================+==========+==========+========+========+========+=======+========+
   | JESD_MODE         |      --- |      --- | 64B66B |  8B10B |  8B10B | 8B10B |   8B10B|
   +-------------------+----------+----------+--------+--------+--------+-------+--------+
   | RX_LANE_RATE      |       10 |       15 |  24.75 |     10 |     10 |    10 |     10 |
   +-------------------+----------+----------+--------+--------+--------+-------+--------+
   | TX_LANE_RATE      |       10 |       15 |  24.75 |     10 |     10 |    10 |     10 |
   +-------------------+----------+----------+--------+--------+--------+-------+--------+
   | REF_CLK_RATE      |      250 |      375 |    375 |    --- |    --- |   --- |    --- |
   +-------------------+----------+----------+--------+--------+--------+-------+--------+
   ...
   +-------------------+----------+----------+--------+--------+--------+-------+--------+
   | RX_JESD_S         |        1 |        1 |      2 |      1 |      1 |     1 |      1 |
   +-------------------+----------+----------+--------+--------+--------+-------+--------+
   | RX_JESD_NP        |       16 |       16 |     12 |     16 |     16 |    16 |     16 |
   +-------------------+----------+----------+--------+--------+--------+-------+--------+
   ...
   +-------------------+----------+----------+--------+--------+--------+-------+--------+
   | TX_JESD_S         |        1 |        1 |      2 |      1 |      1 |     1 |      1 |
   +-------------------+----------+----------+--------+--------+--------+-------+--------+
   | TX_JESD_NP        |       16 |       16 |     12 |     16 |     16 |    16 |     16 |
   +-------------------+----------+----------+--------+--------+--------+-------+--------+
   ...
   | TDD_SYNC_EXT_CDC  |      --- |      --- |    --- |    --- |    --- |   --- |      0 |
   +-------------------+----------+----------+--------+--------+--------+-------+--------+
   | RX_KS_PER_CHANNEL |       32 |       32 |     64 |     64 |  16384 |   --- |    --- |
   +-------------------+----------+----------+--------+--------+--------+-------+--------+
   | TX_KS_PER_CHANNEL |       32 |       32 |     64 |     64 |  16384 |   --- |    --- |
   +-------------------+----------+----------+--------+--------+--------+-------+--------+
   | ADC_DO_MEM_TYPE   |      --- |      --- |    --- |    --- |      2 |   --- |    --- |
   +-------------------+----------+----------+--------+--------+--------+-------+--------+
   | DAC_DO_MEM_TYPE   |      --- |      --- |    --- |    --- |      2 |   --- |    --- |
