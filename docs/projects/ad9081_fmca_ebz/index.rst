...
.. warning::
   ...
   For `A10SoC`_ and `S10SoC`_ setups, the following reworks are required on the evaluation
   board:
   ...
   For the `S10SoC`_ carrier, the following rework is mandatory:

   -  By default, some FMC header pins are connected to an onboard clocking chip. 
      These need to be changed and connected to the FPGA directly: 
      Remove the zero Ohm resistors R228/R229, and install R232/233
...
.. image:: ad9081_clock_scheme_s10soc.svg
   :width: 800
   :align: center
   :alt: AD9081-FMCA-EBZ S10SoC clock scheme
...
.. collapsible:: Default values of the ``make`` parameters for AD9081-FMCA-EBZ
   ...
   |                   +----------+----------+--------+--------+--------+-------+--------+--------+
   |                   |   S10SoC |   A10SoC | VCK190 | VPK180 | VCU118 | VCU128 | ZC706 | ZCU102 |
   +===================+==========+==========+========+========+========+========+=======+========+
   | JESD_MODE         |      --- |      --- | 64B66B | 64B66B |  8B10B |  8B10B | 8B10B |   8B10B|
   +-------------------+----------+----------+--------+--------+--------+--------+-------+--------+
   | RX_LANE_RATE      |       10 |       10 |  24.75 |  24.75 |     10 |     10 |    10 |     10 |
   +-------------------+----------+----------+--------+--------+--------+--------+-------+--------+
   | TX_LANE_RATE      |       10 |       10 |  24.75 |  24.75 |     10 |     10 |    10 |     10 |
   +-------------------+----------+----------+--------+--------+--------+--------+-------+--------+
   | REF_CLK_RATE      |      --- |      --- |    375 |    375 |    --- |    --- |   --- |    --- |
   +-------------------+----------+----------+--------+--------+--------+--------+-------+--------+
   | RX_JESD_M         |        8 |        8 |      8 |      8 |      8 |      8 |     8 |      8 |
   +-------------------+----------+----------+--------+--------+--------+--------+-------+--------+
   | RX_JESD_L         |        4 |        4 |      8 |      8 |      4 |      4 |     4 |      4 |
   +-------------------+----------+----------+--------+--------+--------+--------+-------+--------+
   ...
   | TDD_SYNC_EXT_CDC  |      --- |      --- |    --- |    --- |    --- |    --- |   --- |      0 |
   +-------------------+----------+----------+--------+--------+--------+--------+-------+--------+
   | RX_KS_PER_CHANNEL |       32 |       32 |     64 |     64 |     64 |  16384 |   --- |    --- |
   +-------------------+----------+----------+--------+--------+--------+--------+-------+--------+
   | TX_KS_PER_CHANNEL |       32 |       32 |     64 |     64 |     64 |  16384 |   --- |    --- |
   +-------------------+----------+----------+--------+--------+--------+--------+-------+--------+
   | ADC_DO_MEM_TYPE   |      --- |      --- |    --- |    --- |    --- |      2 |   --- |    --- |
   +-------------------+----------+----------+--------+--------+--------+--------+-------+--------+
   | DAC_DO_MEM_TYPE   |      --- |      --- |    --- |    --- |    --- |      2 |   --- |    --- |
