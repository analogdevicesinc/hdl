...
For example, AD4858-FMCZ board contains AD4858 chip, which is a 20-bit, low
...
little bit. In the sens that there is an extra clock 'external_fast_clk', see
the detailes in the diagram below.

For this evaluation boards, we used an internal clock of the FPGA.
...
The sources available :git-hdl:`here </>`. To get the source you must
...
- Product datasheets: :adi:`AD4858`
- :dokuwiki:`EVAL-AD4858 user guide <resources/eval/ad4858_fmcz>`
- Product datasheets: :adi:`AD4857`
- :dokuwiki:`EVAL-AD4857 user guide <resources/eval/ad4858_fmcz>`
- Product datasheets: :adi:`AD4856`
- :dokuwiki:`EVAL-AD4856 user guide <resources/eval/ad4858_fmcz>`
- Product datasheets: :adi:`AD4855`
- :dokuwiki:`EVAL-AD4855 user guide <resources/eval/ad4858_fmcz>`
- Product datasheets: :adi:`AD4854`
- :dokuwiki:`EVAL-AD4854 user guide <resources/eval/ad4858_fmcz>`
- Product datasheets: :adi:`AD4853`
- :dokuwiki:`EVAL-AD4853 user guide <resources/eval/ad4858_fmcz>`
- Product datasheets: :adi:`AD4852`
- :dokuwiki:`EVAL-AD4852 user guide <resources/eval/ad4858_fmcz>`
- Product datasheets: :adi:`AD4851`
- :dokuwiki:`EVAL-AD4851 user guide <resources/eval/ad4858_fmcz>`
