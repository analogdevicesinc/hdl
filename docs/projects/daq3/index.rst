...
the use of :git-hdl:`DATA_OFFLOAD <library/data_offload>`: in the Zynq
UltraScale-based designs, it is not used due to HP ports' superior bandwidth.
...
ad9152_data_offload  0x7C43_0000     ---
