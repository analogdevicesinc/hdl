...
================================  =========  =======  =========
pulsar_gpio[0] (PD) *             INOUT      32       86
pulsar_gpio[1] (TURBO) *          INOUT      33       87
pulsar_spi_cs (SPI_OP_MODE=1) *   OUT        34       88
pulsar_spi_sdo (SPI_OP_MODE=2) *  OUT        34       88
pulsar_adc_spi_pd **              INOUT      32       86
================================  =========  =======  =========
...
.. admonition:: Legend
   ...
   - ``*`` - signals present only in the ZED project with ``FMC_N_PMOD=1``
     (eval. board connected through FMC)
   - ``**`` - ``pulsar_adc_spi_pd`` is present only in the Cora Z7S project
