...
The data acquisition board incorporates the AD4170-4, a DC to 50 kHz input 
bandwidth, low noise, high speed, completely integrated analog front end for 
...
and can be configured to have four differential inputs or eight single-ended or 
...
:adi:`AD4170-4` 24-bit precision ADC. This instance provides support for
...
- :git-linux:`AD4170 Linux driver source code <analogdevicesinc/linux/blob/main/drivers/iio/adc/ad4170.c>`
