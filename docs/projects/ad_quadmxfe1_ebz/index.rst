...
The Quad-MxFE System Development Platform contains four :adi:`AD9081` MxFE
...
.. important::
   ...
   .. shell:: bash
      ...
      $make JESD_MODE=64B66B RX_LANE_RATE=16.5 TX_LANE_RATE=16.5 REF_CLK_RATE=250 RX_JESD_M=8 RX_JESD_L=2 TX_JESD_M=16 TX_JESD_L=4

Example block design with DAC {M=16 L=4}, and ADC {M=8 L=2}
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

- JESD204B with lane rate 16.5Gbps
- RX: L=4, M=8, S=1, NP=16
- TX: L=4, M=8, S=1, NP=16
