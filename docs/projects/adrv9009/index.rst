...
- :adi:`ADRV9008/9 <EVAL-ADRV9008-9009>`
...
.. image:: adrv9009_jesd204b.svg
   :width: 800
   :align: center
   :alt: ADRV9009 JESD204B M=4 L=4 block diagram
...
to the cores at 128bits @245.76MHz in the transmit and 64bits @245.76MHz for the
receive channels. The sniffer/observation rates depend on the mode selected. The
data is sent or received based on the configuration (programmable) from separate
...
.. note::
   ...
   **system_project.tcl** file, located in
   hdl/projects/adrv9009/$CARRIER/system_project.tcl
...
======================= === ========== =========== ============ =============
axi_adrv9009_rx_os_jesd 8   52         84          104          136
axi_adrv9009_tx_jesd    9   53         85          105          137
axi_adrv9009_rx_jesd    10  54         86          106          138
axi_adrv9009_rx_os_dma  11  55         87          107          139
axi_adrv9009_tx_dma     12  56         88          108          140
...
.. collapsible:: Default values of the make parameters for ADRV9009
   ...
   | TX_JESD_S         |      1 |      1 |      1 |     1 |      1 |
   +-------------------+--------+--------+--------+-------+--------+
   | RX_OS_JESD_M      |      2 |      2 |      2 |     2 |      2 |
   +-------------------+--------+--------+--------+-------+--------+
   | RX_OS_JESD_L      |      2 |      2 |      2 |     2 |      2 |
   +-------------------+--------+--------+--------+-------+--------+
   | RX_OS_JESD_S      |      1 |      1 |      1 |     1 |      1 |
   +-------------------+--------+--------+--------+-------+--------+
...
- `UG-1578, Hardware Reference Manual <https://www.analog.com/media/en/technical-documentation/user-guides/adrv9008-1-w-9008-2-w-9009-w-hardware-reference-manual-ug-1295.pdf>`__

HDL related
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

- :git-hdl:`ADRV9009 HDL project source code <projects/adrv9009>`
...
- :git-linux:`ADRV9009 + A10SoC device tree <arch/arm/boot/dts/intel/socfpga/socfpga_arria10_socdk_adrv9009_jesd204_fsm.dts>`
- :git-no-os:`ADRV9009 NO-OS PROJECT <projects/adrv9009>`
