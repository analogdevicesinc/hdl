...
create_clock -name adc_clk          -period 2.17    [get_ports adc_clk_p]
create_clock -name adc_core_clk     -period 8.70    [get_pins i_system_wrapper/system_i/axi_ad9434/adc_clk]
