...
proc calc_tpl_width {link_datapath_width jesd_l jesd_m jesd_s jesd_np} {
  ...
  if {$jesd_f % 3 == 0} {
    ...
    return [expr $jesd_f > $link_datapath_width ? $jesd_f : $link_datapath_width]
  }
...
set RX_DATAPATH_WIDTH [calc_tpl_width $RX_TPL_DATA_PATH_WIDTH $RX_JESD_L $RX_JESD_M $RX_JESD_S $RX_JESD_NP]
set RX_SAMPLES_PER_CHANNEL [expr $RX_NUM_OF_LANES * 8*$RX_DATAPATH_WIDTH / \
...
set TX_DATAPATH_WIDTH [calc_tpl_width $TX_TPL_DATA_PATH_WIDTH $TX_JESD_L $TX_JESD_M $TX_JESD_S $TX_JESD_NP]
set TX_SAMPLES_PER_CHANNEL [expr $TX_NUM_OF_LANES * 8*$TX_DATAPATH_WIDTH / \
...
set adc_data_width [expr 8*$RX_DATAPATH_WIDTH*$RX_NUM_OF_LANES*$RX_DMA_SAMPLE_WIDTH/$RX_SAMPLE_WIDTH]
...
set dac_data_width [expr 8*$TX_DATAPATH_WIDTH*$TX_NUM_OF_LANES*$TX_DMA_SAMPLE_WIDTH/$TX_SAMPLE_WIDTH]
...
set_instance_parameter_value mxfe_rx_jesd204 {TPL_DATA_PATH_WIDTH} $RX_DATAPATH_WIDTH
...
set_instance_parameter_value mxfe_rx_tpl {OCTETS_PER_BEAT} $RX_DATAPATH_WIDTH
...
set_instance_parameter_value mxfe_tx_jesd204 {TPL_DATA_PATH_WIDTH} $TX_DATAPATH_WIDTH
...
set_instance_parameter_value mxfe_tx_tpl {OCTETS_PER_BEAT} $TX_DATAPATH_WIDTH
...
add_instance mxfe_pio1 altera_avalon_pio
set_instance_parameter_value mxfe_pio1 {direction} {InOut}
set_instance_parameter_value mxfe_pio1 {generateIRQ} {1}
set_instance_parameter_value mxfe_pio1 {width} {32}
set_instance_parameter_value mxfe_pio1 {edgeType} {RISING}
add_interface mxfe_pio1 conduit end
set_interface_property mxfe_pio1 EXPORT_OF mxfe_pio1.external_connection

add_instance mxfe_pio2 altera_avalon_pio
set_instance_parameter_value mxfe_pio2 {direction} {InOut}
set_instance_parameter_value mxfe_pio2 {generateIRQ} {1}
set_instance_parameter_value mxfe_pio2 {width} {32}
set_instance_parameter_value mxfe_pio2 {edgeType} {RISING}
add_interface mxfe_pio2 conduit end
set_interface_property mxfe_pio2 EXPORT_OF mxfe_pio2.external_connection
...
add_connection sys_clk.clk mxfe_pio1.clk
add_connection sys_clk.clk mxfe_pio2.clk
...
add_connection sys_clk.clk_reset mxfe_pio1.reset
add_connection sys_clk.clk_reset mxfe_pio2.reset
...
ad_cpu_interconnect 0x000E2000 mxfe_pio1.s1
ad_cpu_interconnect 0x000E4000 mxfe_pio2.s1
...
ad_cpu_interrupt 16  mxfe_pio1.irq
ad_cpu_interrupt 17  mxfe_pio2.irq
