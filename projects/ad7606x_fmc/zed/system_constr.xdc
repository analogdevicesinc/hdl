...
#set_property -dict {PACKAGE_PIN N18     IOSTANDARD LVCMOS25} [get_ports ]         ; ## H17 FMC_LPC_LA11_N
#set_property -dict {PACKAGE_PIN P21     IOSTANDARD LVCMOS25} [get_ports ]         ; ## G16 FMC_LPC_LA12_N
#set_property -dict {PACKAGE_PIN T17     IOSTANDARD LVCMOS25} [get_ports ad7606_spi_sdi[4]]         ; ## H14 FMC_LPC_LA07_N
#set_property -dict {PACKAGE_PIN J22     IOSTANDARD LVCMOS25} [get_ports ad7606_spi_sdi[5]]         ; ## G13 FMC_LPC_LA08_N
#set_property -dict {PACKAGE_PIN M20     IOSTANDARD LVCMOS25} [get_ports ad7606_spi_sdi[6]]         ; ## G07 FMC_LPC_LA00_CC_N
#set_property -dict {PACKAGE_PIN L22     IOSTANDARD LVCMOS25} [get_ports ad7606_spi_sdi[7]]         ; ## C11 FMC_LPC_LA06_N
#set_property -dict {PACKAGE_PIN J18     IOSTANDARD LVCMOS25} [get_ports ad7606_spi_sdi[0]]         ; ## D11 FMC_LPC_LA05_P
#set_property -dict {PACKAGE_PIN R20     IOSTANDARD LVCMOS25} [get_ports ad7606_spi_sdi[1]]         ; ## D14 FMC_LPC_LA09_P
#set_property -dict {PACKAGE_PIN N22     IOSTANDARD LVCMOS25} [get_ports ad7606_spi_sdi[2]]         ; ## G09 FMC_LPC_LA03_P
#set_property -dict {PACKAGE_PIN N18     IOSTANDARD LVCMOS25} [get_ports ad7606_spi_sdi[3]]         ; ## H17 FMC_LPC_LA11_N
#set_property -dict {PACKAGE_PIN P21     IOSTANDARD LVCMOS25} [get_ports ad7606_spi_sdo]         ; ## G16 FMC_LPC_LA12_N
#set_property -dict {PACKAGE_PIN L17     IOSTANDARD LVCMOS25} [get_ports adc_db[2]]         ; ## D17 FMC_LPC_LA13_P
#set_property -dict {PACKAGE_PIN M17     IOSTANDARD LVCMOS25} [get_ports adc_db[3]]         ; ## D18 FMC_LPC_LA13_N
...
#set_false_path -to [get_pins -hierarchical * -filter {NAME=~*busy_sync/inst/cdc_sync_stage2_reg[0]/D}]

#set_false_path -from [get_clocks -of_objects [get_pins i_system_wrapper/system_i/spi_clkgen/inst/i_mmcm_drp/i_mmcm/CLKOUT0]] -to [get_clocks clk_fpga_0]

#set_property -dict {PACKAGE_PIN Y11     IOSTANDARD LVCMOS33} [get_ports rx_trigger];  # "JA1"