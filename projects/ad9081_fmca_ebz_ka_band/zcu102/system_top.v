...
module system_top  #(
  ...
  assign ext_csb_tile1 = spi_csn[0];
  assign ext_csb_tile2 = spi_csn[1];
  assign ext_csb_tile3 = spi_csn[2];
  assign ext_csb_tile4 = spi_csn[3];
  ...
  ad_iobuf #(.DATA_WIDTH(4)) i_iobuf_gpio (
   .dio_t (gpio_t[63:60]),
   .dio_i (gpio_o[63:60]),
   .dio_o (gpio_i[63:60]),
   .dio_p ({
