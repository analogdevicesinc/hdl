...
set_property -dict [list CONFIG.PSU__CRF_APB__DP_VIDEO_REF_CTRL__SRCSEL {VPLL} CONFIG.PSU__CRF_APB__DP_AUDIO_REF_CTRL__SRCSEL {VPLL} CONFIG.PSU__CRF_APB__DP_STC_REF_CTRL__SRCSEL {VPLL}] [get_bd_cells sys_ps8]
