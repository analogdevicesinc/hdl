...
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS25}  [get_ports ad463x_spi_sdi1]       ; ## H08  FMC_LPC_LA02_N
#set_property -dict {PACKAGE_PIN N22 IOSTANDARD LVCMOS25} [get_ports ad463x_spi_sdi2]       ; ## G09  FMC_LPC_LA03_P
#set_property -dict {PACKAGE_PIN P22 IOSTANDARD LVCMOS25} [get_ports ad463x_spi_sdi3]       ; ## G10  FMC_LPC_LA03_N
#set_property -dict {PACKAGE_PIN M21 IOSTANDARD LVCMOS25} [get_ports ad463x_spi_sdi4]       ; ## H10  FMC_LPC_LA04_P
#set_property -dict {PACKAGE_PIN M22 IOSTANDARD LVCMOS25} [get_ports ad463x_spi_sdi5]       ; ## H11  FMC_LPC_LA04_N
#set_property -dict {PACKAGE_PIN J18 IOSTANDARD LVCMOS25} [get_ports ad463x_spi_sdi6]       ; ## D11  FMC_LPC_LA05_P
#set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS25} [get_ports ad463x_spi_sdi7]       ; ## D12  FMC_LPC_LA05_N
