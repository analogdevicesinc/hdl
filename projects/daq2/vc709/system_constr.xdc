...
set_property  -dict {PACKAGE_PIN  M42 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports rx_sysref_p]               ; ## G09  FMC1_HPC_LA03_P
set_property  -dict {PACKAGE_PIN  L42 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports rx_sysref_n]               ; ## G10  FMC1_HPC_LA03_N
set_property  -dict {PACKAGE_PIN  P41 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports tx_sync_p]                 ; ## H07  FMC1_HPC_LA02_P
set_property  -dict {PACKAGE_PIN  N41 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports tx_sync_n]                 ; ## H08  FMC1_HPC_LA02_N
set_property  -dict {PACKAGE_PIN  H40 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports tx_sysref_p]               ; ## H10  FMC1_HPC_LA04_P
set_property  -dict {PACKAGE_PIN  H41 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports tx_sysref_n]               ; ## H11  FMC1_HPC_LA04_N
...
set_property  -dict {PACKAGE_PIN  G41 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports trig_p]                    ; ## H13  FMC1_HPC_LA07_P
set_property  -dict {PACKAGE_PIN  G42 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports trig_n]                    ; ## H14  FMC1_HPC_LA07_N
