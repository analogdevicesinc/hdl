...
set_property -dict {PACKAGE_PIN N18  IOSTANDARD LVCMOS25} [get_ports spi_sdo]    ; ## FMC_LPC_LA11_N
set_property -dict {PACKAGE_PIN K21  IOSTANDARD LVCMOS25} [get_ports spi_sdi]    ; ## FMC_LPC_LA16_N
