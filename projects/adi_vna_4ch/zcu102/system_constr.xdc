...
# device clock
set_property  -dict {PACKAGE_PIN  Y4  IOSTANDARD LVDS}      [get_ports glblclk_p]          ; ##  G6   FMC_HPC0_LA00_CC_P
set_property  -dict {PACKAGE_PIN  Y3  IOSTANDARD LVDS}      [get_ports glblclk_n]          ; ##  G7   FMC_HPC0_LA00_CC_N
...
# SPI
set_property  -dict {PACKAGE_PIN  V2   IOSTANDARD LVCMOS18} [get_ports fpga_csb]           ; ##  H7   FMC_HPC0_LA02_P
set_property  -dict {PACKAGE_PIN  AB4  IOSTANDARD LVCMOS18} [get_ports fpga_clk]           ; ##  D8   FMC_HPC0_LA01_CC_P
set_property  -dict {PACKAGE_PIN  AC4  IOSTANDARD LVCMOS18} [get_ports fpga_sdio]          ; ##  D9   FMC_HPC0_LA01_CC_N
set_property  -dict {PACKAGE_PIN  M10  IOSTANDARD LVCMOS18} [get_ports fpga_sdo]           ; ##  C26  FMC_HPC0_LA27_P ~

############################################################################### ~~~~~~~ missing c27 connection
...
########################################################################################################################################### missing pair 7
# set_property  -dict {PACKAGE_PIN  H6}                       [get_ports dac_data_p[6]]      ; ##  A22  FMC_HPC0_DP1_C2M_P       SERDESP<6>   P/N ~ N/P #####
...
set_property  -dict {PACKAGE_PIN  N4}                       [get_ports dac_data_p[3]]      ; ##  B32  FMC_HPC0_DP7_C2M_P       SERDESP<3>
set_property  -dict {PACKAGE_PIN  N3}                       [get_ports dac_data_n[3]]      ; ##  B33  FMC_HPC0_DP7_C2M_N       SERDESN<3>
set_property  -dict {PACKAGE_PIN  M6}                       [get_ports dac_data_p[2]]      ; ##  A34  FMC_HPC0_DP4_C2M_P       SERDESP<2>
set_property  -dict {PACKAGE_PIN  M5}                       [get_ports dac_data_n[2]]      ; ##  A35  FMC_HPC0_DP4_C2M_N       SERDESN<2>
set_property  -dict {PACKAGE_PIN  R4}                       [get_ports dac_data_p[1]]      ; ##  B36  FMC_HPC0_DP6_C2M_P       SERDESP<1>
set_property  -dict {PACKAGE_PIN  R3}                       [get_ports dac_data_n[1]]      ; ##  B37  FMC_HPC0_DP6_C2M_N       SERDESN<1>
set_property  -dict {PACKAGE_PIN  P6}                       [get_ports dac_data_p[0]]      ; ##  A38  FMC_HPC0_DP5_C2M_P       SERDESP<0>
set_property  -dict {PACKAGE_PIN  P5}                       [get_ports dac_data_n[0]]      ; ##  A39  FMC_HPC0_DP5_C2M_N       SERDESN<0>

set_property  -dict {PACKAGE_PIN  V8   IOSTANDARD LVDS}     [get_ports sync0_n]            ; ##  G33  FMC_HPC0_LA31_P  #P/N pair correctly assigned ?
set_property  -dict {PACKAGE_PIN  V7   IOSTANDARD LVDS}     [get_ports sync0_p]            ; ##  G34  FMC_HPC0_LA31_N

set_property  -dict {PACKAGE_PIN  V12  IOSTANDARD LVDS}     [get_ports sync1_n]            ; ##  G36  FMC_HPC0_LA33_P   #P/N pair correctly assigned ?
...
set_property  -dict {PACKAGE_PIN  AA12 IOSTANDARD LVCMOS18} [get_ports clkd_lvsft_en]      ; ##  G19  FMC_HPC0_LA16_N   ??? missing connection
...
set_property  -dict {PACKAGE_PIN  Y2   IOSTANDARD LVCMOS18} [get_ports fpga_bus0_rstn]     ; ##  G9   FMC_HPC0_LA03_P  ~
...
set_property  -dict {PACKAGE_PIN  T7   IOSTANDARD LVCMOS18} [get_ports adcscko]            ; ##  H31  FMC_HPC0_LA28_P  ~ new
set_property  -dict {PACKAGE_PIN  T6   IOSTANDARD LVCMOS18} [get_ports adcscki]            ; ##  H32  FMC_HPC0_LA28_N  ~

set_property  -dict {PACKAGE_PIN  V6   IOSTANDARD LVCMOS18} [get_ports adccnv]             ; ##  H34  FMC_HPC0_LA30_P  ~ new
