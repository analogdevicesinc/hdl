...
module system_top (
  ...
  assign gpio_i[44:40] = 'h0;

  assign gpio_i[39:33] = gpio_bd_i[5:0];
  assign gpio_bd_o[7:0] = gpio_o[44:37];
  ...
  system_bd i_system_bd (
    ...
    .if_clk_in_bd_clk_in(clk_in),
    .if_data_in_bd_data_in(data_in),
    .if_ready_in_bd_ready_in(ready_in),
