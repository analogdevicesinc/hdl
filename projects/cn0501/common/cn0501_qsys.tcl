...
set_instance_parameter_value axi_dmac_0 {DMA_DATA_WIDTH_SRC} {256}
...
add_connection util_ad7768_adc_pack.if_packed_fifo_wr_en  axi_dmac_0.if_fifo_wr_en
add_connection util_ad7768_adc_pack.if_packed_fifo_wr_sync axi_dmac_0.if_fifo_wr_sync
add_connection util_ad7768_adc_pack.if_packed_fifo_wr_data axi_dmac_0.if_fifo_wr_din
add_connection util_ad7768_adc_pack.if_packed_fifo_wr_overflow axi_dmac_0.if_fifo_wr_overflow
...
add_connection axi_dmac_0.m_dest_axi sys_hps.f2h_sdram1_data

# cpu interconnects

ad_cpu_interconnect 0x00028000 axi_dmac_0.s_axi
ad_cpu_interconnect 0x00030000 axi_ad7768_0.s_axi

#interrupts

ad_cpu_interrupt 5 axi_dmac_0.interrupt_sender
