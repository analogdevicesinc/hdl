...
module system_top (
  ...
  // activity) so the pins are constrained and the board routing is exercised.
  assign emg_aux0_cs = 1'b1;
  assign emg_aux0_sclk = 1'b0;
  assign emg_aux0_sdi = 1'b0;

  assign emg_aux1_cs = 1'b1;
  assign emg_aux1_sclk = 1'b0;
  assign emg_aux1_sdi = 1'b0;
