...
create_bd_intf_port -mode Master -vlnv analog.com:interface:spi_engine_rtl:1.0 emg_di
create_bd_port -dir O emg_odr
create_bd_port -dir O emg_sdpclk

# create a SPI Engine architecture for the parallel data interface of AD4134
# this design supports AD7132/AD7134/AD7136/AD4134
...
ad_connect  $hier_spi_engine/m_spi emg_di
...
# amplifier SPI interface (directly via PS SPI1, active CS via GPIO [58:51])
