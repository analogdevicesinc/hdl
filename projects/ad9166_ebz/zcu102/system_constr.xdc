...
set_property -dict {PACKAGE_PIN Y4  IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports tx_sysref_p]     ; ## G6   FMC0_LA00_CC_P        IO_L13P_T2L_N0_GC_QBC_66
set_property -dict {PACKAGE_PIN Y3  IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports tx_sysref_n]     ; ## G7   FMC0_LA00_CC_N        IO_L13N_T2L_N1_GC_QBC_66
...
set_property -dict {PACKAGE_PIN N4}  [get_ports tx_data_n[4]]                                   ; ## B32  FMC0_DP7_C2M_P        MGTHTXP2_228
...
set_property -dict {PACKAGE_PIN R4}  [get_ports tx_data_n[6]]                                   ; ## B36  FMC0_DP6_C2M_P        MGTHTXP0_228
...
# FMC_CS2 (HMC7044)
set_property -dict {PACKAGE_PIN AB3 IOSTANDARD LVCMOS18} [get_ports spi_csb_hmc7044]            ; ## D11  FMC0_LA05_P           IO_L20P_T3L_N2_AD1P_66
# FMC_CS3 (ADF4372)
set_property -dict {PACKAGE_PIN AC2 IOSTANDARD LVCMOS18} [get_ports spi_cs_adf4372]             ; ## C10  FMC0_LA06_P           IO_L19P_T3L_N0_DBC_AD9P_66
# FMC_CS4 (Amplifier)
set_property -dict {PACKAGE_PIN AC1 IOSTANDARD LVCMOS18} [get_ports spi_cs_amp]                 ; ## C11  FMC0_LA06_N           IO_L19N_T3L_N1_DBC_AD9N_66
