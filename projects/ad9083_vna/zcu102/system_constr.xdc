...
#set_property  -dict {PACKAGE_PIN  N9   IOSTANDARD LVCMOS18} [get_ports lmix_rstn]          ; ##  C22  FMC_HPC0_LA18_P_CC # double
#set_property  -dict {PACKAGE_PIN  N8   IOSTANDARD LVCMOS18} [get_ports smix_rstn]          ; ##  C23  FMC_HPC0_LA18_N_CC #

#set_property  -dict {PACKAGE_PIN  T6   IOSTANDARD LVCMOS18} [get_ports adcsck]             ; ##  H32  FMC_HPC0_LA28_N
...
#set_property  -dict {PACKAGE_PIN  L13  IOSTANDARD LVCMOS18} [get_ports adc_mon_csb]        ; ##  H22  FMC_HPC0_LA19_P
#set_property  -dict {PACKAGE_PIN  Y2   IOSTANDARD LVCMOS18} [get_ports adcmon_rstn]        ; ##  G09  FMC_HPC0_LA03_P
# X adcscko
...
set_property  -dict {PACKAGE_PIN  V8   IOSTANDARD LVDS}     [get_ports sync0_p]            ; ##  G33  FMC_HPC0_LA31_P
set_property  -dict {PACKAGE_PIN  V7   IOSTANDARD LVDS}     [get_ports sync0_n]            ; ##  G34  FMC_HPC0_LA31_N

set_property  -dict {PACKAGE_PIN  V12  IOSTANDARD LVDS}     [get_ports sync1_p]            ; ##  G36  FMC_HPC0_LA33_P
set_property  -dict {PACKAGE_PIN  V11  IOSTANDARD LVDS}     [get_ports sync1_n]            ; ##  G37  FMC_HPC0_LA33_N

set_property  -dict {PACKAGE_PIN  AA7  IOSTANDARD LVDS}     [get_ports sysrefdac_p]        ; ##  H04  FMC_HPC0_CLK0_M2C_P (DNI)
set_property  -dict {PACKAGE_PIN  AA6  IOSTANDARD LVDS}     [get_ports sysrefdac_n]        ; ##  H05  FMC_HPC0_CLK0_M2C_N (DNI)
...
set_property  -dict {PACKAGE_PIN  L11  IOSTANDARD LVCMOS18} [get_ports spi_bus1_cs1]       ; ##  G28  FMC_HPC0_LA25_N
set_property  -dict {PACKAGE_PIN  U9   IOSTANDARD LVCMOS18} [get_ports spi_bus1_cs2]       ; ##  G30  FMC_HPC0_LA29_P
...
set_property  -dict {PACKAGE_PIN  L15  IOSTANDARD LVCMOS18} [get_ports spi_adl5960_cs_a]   ; ##  D26  FMC_HPC0_LA26_P
set_property  -dict {PACKAGE_PIN  K15  IOSTANDARD LVCMOS18} [get_ports spi_adl5960_cs_b]   ; ##  D27  FMC_HPC0_LA26_N
set_property  -dict {PACKAGE_PIN  AC2  IOSTANDARD LVCMOS18} [get_ports spi_adl5960_cs_c]   ; ##  C10  FMC_HPC0_LA06_P
set_property  -dict {PACKAGE_PIN  AC1  IOSTANDARD LVCMOS18} [get_ports spi_adl5960_cs_d]   ; ##  C11  FMC_HPC0_LA06_N
set_property  -dict {PACKAGE_PIN  W5   IOSTANDARD LVCMOS18} [get_ports spi_adl5960_cs_e]   ; ##  C14  FMC_HPC0_LA10_P
set_property  -dict {PACKAGE_PIN  W4   IOSTANDARD LVCMOS18} [get_ports spi_adl5960_cs_f]   ; ##  C15  FMC_HPC0_LA10_N
set_property  -dict {PACKAGE_PIN  AC7  IOSTANDARD LVCMOS18} [get_ports spi_adl5960_cs_g]   ; ##  C18  FMC_HPC0_LA14_P
set_property  -dict {PACKAGE_PIN  AC6  IOSTANDARD LVCMOS18} [get_ports spi_adl5960_cs_h]   ; ##  C19  FMC_HPC0_LA14_N
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets adcscki_IBUF_inst/O]

create_clock -name adcscki_cmos       -period  10 [get_ports adcscki]
