...
set_property  -dict {PACKAGE_PIN G8   IOSTANDARD ANALOG} [get_ports s_1p0_rf_sns_p]        ; ## IO_L16P_66_1P0_RF_SNS_P
set_property  -dict {PACKAGE_PIN F8   IOSTANDARD ANALOG} [get_ports s_1p0_rf_sns_n]        ; ## IO_L16N_66_1P0_RF_SNS_N
set_property  -dict {PACKAGE_PIN H6   IOSTANDARD ANALOG} [get_ports s_1p8_rf_sns_p]        ; ## IO_L17P_66_1P8_RF_SNS_P
set_property  -dict {PACKAGE_PIN G6   IOSTANDARD ANALOG} [get_ports s_1p8_rf_sns_n]        ; ## IO_L17N_66_1P8_RF_SNS_N
set_property  -dict {PACKAGE_PIN G7   IOSTANDARD ANALOG} [get_ports s_1p3_rf_sns_p]        ; ## IO_L18P_66_1P3_RF_SNS_P
set_property  -dict {PACKAGE_PIN F7   IOSTANDARD ANALOG} [get_ports s_1p3_rf_sns_n]        ; ## IO_L18N_66_1P3_RF_SNS_N
set_property  -dict {PACKAGE_PIN A6   IOSTANDARD ANALOG} [get_ports s_5v0_rf_sns_p]        ; ## IO_L19P_66_5V0_RF_SNS_P
set_property  -dict {PACKAGE_PIN A5   IOSTANDARD ANALOG} [get_ports s_5v0_rf_sns_n]        ; ## IO_L19N_66_5V0_RF_SNS_N
set_property  -dict {PACKAGE_PIN C8   IOSTANDARD ANALOG} [get_ports s_2v5_sns_p]           ; ## IO_L20P_66_2V5_SNS_P
set_property  -dict {PACKAGE_PIN B8   IOSTANDARD ANALOG} [get_ports s_2v5_sns_n]           ; ## IO_L20N_66_2V5_SNS_N
set_property  -dict {PACKAGE_PIN C5   IOSTANDARD ANALOG} [get_ports s_vtt_ps_ddr4_sns_p]   ; ## IO_L21P_66_VTT_PS_DDR4_SNS_P
set_property  -dict {PACKAGE_PIN B5   IOSTANDARD ANALOG} [get_ports s_vtt_ps_ddr4_sns_n]   ; ## IO_L21N_66_VTT_PS_DDR4_SNS_N
set_property  -dict {PACKAGE_PIN A9   IOSTANDARD ANALOG} [get_ports s_1v2_ps_ddr4_sns_p]   ; ## IO_L22P_66_1V2_PS_DDR4_SNS_P
set_property  -dict {PACKAGE_PIN A8   IOSTANDARD ANALOG} [get_ports s_1v2_ps_ddr4_sns_n]   ; ## IO_L22N_66_1V2_PS_DDR4_SNS_N

set_property  -dict {PACKAGE_PIN G3   IOSTANDARD ANALOG} [get_ports s_0v85_mgtravcc_sns_p] ; ## IO_L4P_66_0V85_MGTRAVCC_SNS_P
set_property  -dict {PACKAGE_PIN F3   IOSTANDARD ANALOG} [get_ports s_0v85_mgtravcc_sns_n] ; ## IO_L4N_66_0V85_MGTRAVCC_SNS_N
set_property  -dict {PACKAGE_PIN H4   IOSTANDARD ANALOG} [get_ports s_5v0_sns_p]           ; ## IO_L6P_66_5V0_SNS_P
set_property  -dict {PACKAGE_PIN H3   IOSTANDARD ANALOG} [get_ports s_5v0_sns_n]           ; ## IO_L6N_66_5V0_SNS_N
set_property  -dict {PACKAGE_PIN A3   IOSTANDARD ANALOG} [get_ports s_1v2_sns_p]           ; ## IO_L8P_66_1V2_SNS_P
set_property  -dict {PACKAGE_PIN A2   IOSTANDARD ANALOG} [get_ports s_1v2_sns_n]           ; ## IO_L8N_66_1V2_SNS_N
set_property  -dict {PACKAGE_PIN B3   IOSTANDARD ANALOG} [get_ports s_1v8_mgtravtt_sns_p]  ; ## IO_L10P_66_1V8_MGTRAVTT_SNS_P
set_property  -dict {PACKAGE_PIN B2   IOSTANDARD ANALOG} [get_ports s_1v8_mgtravtt_sns_n]  ; ## IO_L10N_66_1V8_MGTRAVTT_SNS_N
