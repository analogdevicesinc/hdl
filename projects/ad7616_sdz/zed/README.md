...
## Configuration using FMC connector and SDP-I-FMC interposer

Connect the evaluation board to the SDP-I-FMC interposer, then to the FMC LPC connector of Zed.
