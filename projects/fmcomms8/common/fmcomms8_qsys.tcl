...
set dac_data_offload_name fmcomms8_data_offload
...
set_instance_parameter_value axi_fmcomms8_tx_upack {INTERFACE_TYPE} {0}
...
add_connection axi_fmcomms8_tx_upack.if_fifo_rd_underflow axi_fmcomms8_tx.if_dac_dunf
...
add_connection core_clk_c.out_clk $dac_data_offload_name.m_axis_aclk
add_connection fmcomms8_tx_jesd204.link_reset $dac_data_offload_name.m_axis_aresetn
add_connection $dac_data_offload_name.m_axis axi_fmcomms8_tx_upack.s_axis
...
set_instance_parameter_value axi_fmcomms8_tx_dma {HAS_AXIS_TKEEP} {1}
...
add_connection axi_fmcomms8_tx_dma.m_axis $dac_data_offload_name.s_axis
add_connection axi_fmcomms8_tx_dma.if_m_axis_xfer_req $dac_data_offload_name.init_req
