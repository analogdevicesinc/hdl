...
set_property  -dict {PACKAGE_PIN  J27}                       [get_ports ref_clk0_p]        ; ## USER_SMA_MGT_CLOCK_P
set_property  -dict {PACKAGE_PIN  J28}                       [get_ports ref_clk0_n]        ; ## USER_SMA_MGT_CLOCK_N
