...
ad_ip_parameter axi_adrv9026_tx_jesd/tx CONFIG.SYSREF_IOB {false}
...
ad_ip_parameter axi_adrv9026_rx_os_jesd/rx CONFIG.SYSREF_IOB {false}
...
ad_ip_parameter axi_adrv9026_rx_os_dma CONFIG.DMA_DATA_WIDTH_SRC [expr 32*$RX_NUM_OF_LANES]
...
ad_ip_parameter util_adrv9026_xcvr CONFIG.RX_NUM_OF_LANES [expr $RX_NUM_OF_LANES+$RX_OS_NUM_OF_LANES]
...
# Rx-os
ad_xcvrcon  util_adrv9026_xcvr axi_adrv9026_rx_os_xcvr axi_adrv9026_rx_os_jesd {} core_clk
for {set i 0} {$i < $RX_OS_NUM_OF_LANES} {incr i} {
  set ch [expr $RX_NUM_OF_LANES + $i]
  ad_xcvrpll  $rx_os_ref_clk util_adrv9026_xcvr/cpll_ref_clk_$ch
...
ad_connect  core_clk rx_os_adrv9026_tpl_core/link_clk
...
ad_connect  core_clk util_adrv9026_rx_os_cpack/clk
ad_connect  core_clk_rstgen/peripheral_reset util_adrv9026_rx_os_cpack/reset
...
ad_connect  core_clk axi_adrv9026_rx_os_dma/fifo_wr_clk
...
ad_cpu_interconnect 0x44A50000 axi_adrv9026_rx_os_xcvr
ad_cpu_interconnect 0x44AB0000 axi_adrv9026_rx_os_jesd
ad_cpu_interconnect 0x7c440000 axi_adrv9026_rx_os_dma
...
ad_mem_hp2_interconnect $sys_dma_clk axi_adrv9026_rx_os_dma/m_dest_axi
