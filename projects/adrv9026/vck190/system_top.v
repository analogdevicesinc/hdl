...
//  output                  rx_sync_2_n,
  ...
  // Unused GPIOs
  assign gpio_i[95:69] = gpio_o[95:69];
...
//    .OB (rx_sync_2_n));
  ...
  system_wrapper i_system_wrapper (
    ...
    .gt_reset (~gt_powergood | ~adrv9026_reset_b),
    .core_clk (core_clk),
    .link_clk (link_clk),
...
//    .ch0_rxpolarity_ext(1'b1),
//    .ch1_rxpolarity_ext(1'b1),
//    .ch2_rxpolarity_ext(1'b1),
//    .ch3_rxpolarity_ext(1'b1),
//    .ch1_txpolarity_ext(1'b1),
//    .ch3_txpolarity_ext(1'b1));
