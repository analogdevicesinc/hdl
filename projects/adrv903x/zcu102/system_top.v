...
module system_top (
  ...
  inout                   adrv903x_trx0_enable,
  inout                   adrv903x_trx1_enable,
  inout                   adrv903x_trx2_enable,
  inout                   adrv903x_trx3_enable,
  inout                   adrv903x_trx4_enable,
  inout                   adrv903x_trx5_enable,
  inout                   adrv903x_trx6_enable,
  inout                   adrv903x_trx7_enable,
  inout                   adrv903x_orx0_enable,
  inout                   adrv903x_orx1_enable,
  inout                   adrv903x_test,
  inout                   adrv903x_reset_b,

  inout       [23:0]      adrv903x_gpio
);
  ...
  ad_iobuf #(
    ...
    .dio_p ({ ad9528_reset_b,       // 69
              ...
              adrv903x_trx0_enable, // 67
              adrv903x_trx1_enable, // 66
              adrv903x_trx2_enable, // 65
              adrv903x_trx3_enable, // 64
              adrv903x_trx4_enable, // 63
              adrv903x_trx5_enable, // 62
              adrv903x_trx6_enable, // 61
              adrv903x_trx7_enable, // 60
              adrv903x_orx0_enable, // 59
              adrv903x_orx1_enable, // 58
              adrv903x_test,        // 57
              adrv903x_reset_b,     // 56
              adrv903x_gpio}));     // 55-32
  ...
  assign spi_csn_adrv903x =  spi_csn[0];
