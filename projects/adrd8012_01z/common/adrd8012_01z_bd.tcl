...
ad_ip_instance util_vector_logic aux_reset_inv
ad_ip_parameter aux_reset_inv CONFIG.C_OPERATION {not}
ad_ip_parameter aux_reset_inv CONFIG.C_SIZE {1}
...
ad_connect sys_ps8/pl_resetn0 aux_reset_inv/Op1
