...
#define XPAR_XGPIO_NUM_INSTANCES		1 /**< GPIO instances */
#endif
...
//				   ConfigPtr->BaseAddress);
   ...
   //pull IP out of reset
	int status = XGpio_CfgInitialize(InstancePtr, ConfigPtr, ConfigPtr->BaseAddress);
    if (status != XST_SUCCESS)
		return status;

    Xil_Out32(ConfigPtr->BaseAddress + GPIO_RESET_OFFSET, 0x0);
    Xil_Out32(ConfigPtr->BaseAddress + GPIO_RESET_OFFSET, 0x1);
