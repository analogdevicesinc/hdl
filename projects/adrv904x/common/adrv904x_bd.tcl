...
if {$JESD_MODE == "8B10B"} {
  ...
  ad_ip_parameter util_adrv904x_xcvr CONFIG.RX_CLK25_DIV 10
  ad_ip_parameter util_adrv904x_xcvr CONFIG.TX_CLK25_DIV 10
  ad_ip_parameter util_adrv904x_xcvr CONFIG.RX_PMA_CFG 0x001E7080
  ad_ip_parameter util_adrv904x_xcvr CONFIG.QPLL_FBDIV 40
} else {
...
ad_xcvrcon util_adrv904x_xcvr axi_adrv904x_tx_xcvr axi_adrv904x_tx_jesd {} {} adrv904x_tx_device_clk $MAX_TX_NUM_OF_LANES {6 5 7 4 2 0 1 3}
...
ad_xcvrcon  util_adrv904x_xcvr axi_adrv904x_rx_xcvr axi_adrv904x_rx_jesd {} {} adrv904x_rx_device_clk $MAX_RX_NUM_OF_LANES {1 0 3 2 7 4 5 6}
...
# Rx - OBS
  ...
  ad_xcvrcon  util_adrv904x_xcvr axi_adrv904x_rx_os_xcvr axi_adrv904x_rx_os_jesd {4 5 6 7} {} adrv904x_rx_os_device_clk $MAX_RX_OS_NUM_OF_LANES {7 4 5 6}
