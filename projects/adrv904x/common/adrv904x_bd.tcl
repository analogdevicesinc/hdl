...
# set TX_DATAPATH_WIDTH [expr max(4, $TX_OCTETS_PER_FRAME)] ; #max(4, F)
# set TX_SAMPLES_PER_CHANNEL [expr $TX_NUM_OF_LANES * 8 * $TX_DATAPATH_WIDTH / ($TX_NUM_OF_CONVERTERS * $TX_SAMPLE_WIDTH)] ; # L * 8 * DPW / (M* N)
...
# set RX_SAMPLES_PER_CHANNEL [expr $RX_NUM_OF_LANES * 8 * $RX_DATAPATH_WIDTH / ($RX_NUM_OF_CONVERTERS * $RX_SAMPLE_WIDTH)] ; # L * 8 * DPW / (M* N)
...
if {$ORX_ENABLE} {
# set RX_OS_OCTETS_PER_FRAME [expr $RX_0S_NUM_OF_CONVERTERS * $RX_OS_SAMPLES_PER_FRAME * $RX_OS_SAMPLE_WIDTH / (8 * $RX_OS_NUM_OF_LANES)] ; # F
# set RX_OS_DATAPATH_WIDTH [expr max(4, $RX_OS_OCTETS_PER_FRAME)] ; #max(4, F)
# set RX_OS_SAMPLES_PER_CHANNEL [expr $RX_OS_NUM_OF_LANES * 8 * $RX_OS_DATAPATH_WIDTH / ($RX_OS_NUM_OF_CONVERTERS * $RX_OS_SAMPLE_WIDTH)] ; # L * 8 * DPW / (M* N)
...
# Rx - OBS
  ...
  ad_xcvrcon  util_adrv904x_xcvr axi_adrv904x_rx_os_xcvr axi_adrv904x_rx_os_jesd {} {} adrv904x_rx_os_device_clk $RX_OS_NUM_OF_LANES
