...
module system_top (
  ...
  system_wrapper i_system_wrapper (
    ...
    .rx_data_2_n (rx_data_n[1]),
    .rx_data_2_p (rx_data_p[1]),
    .rx_data_3_n (rx_data_n[3]),
    .rx_data_3_p (rx_data_p[3]),
    .rx_data_4_n (rx_data_n[5]),
    .rx_data_4_p (rx_data_p[5]),
    .rx_data_5_n (rx_data_n[4]),
    .rx_data_5_p (rx_data_p[4]),
    ...
    .spi1_miso (1'b0),
    .spi1_mosi (),
    .tx_data_0_n (tx_data_n[7]),
    .tx_data_0_p (tx_data_p[7]),
    .tx_data_1_n (tx_data_n[6]),
    .tx_data_1_p (tx_data_p[6]),
    .tx_data_2_n (tx_data_n[5]),
    .tx_data_2_p (tx_data_p[5]),
    .tx_data_3_n (tx_data_n[4]),
    .tx_data_3_p (tx_data_p[4]),
    .tx_data_4_n (tx_data_n[0]),
    .tx_data_4_p (tx_data_p[0]),
    .tx_data_5_n (tx_data_n[1]),
    .tx_data_5_p (tx_data_p[1]),
    .tx_data_6_n (tx_data_n[2]),
    .tx_data_6_p (tx_data_p[2]),
    .tx_data_7_n (tx_data_n[3]),
    .tx_data_7_p (tx_data_p[3]),
