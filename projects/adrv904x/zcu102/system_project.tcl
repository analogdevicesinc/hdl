...
#
# e.g. JESD and XCVR
#   make JESD_MODE=64B66B ORX_ENABLE=1 RX_OS_JESD_M=8 RX_OS_JESD_L=4 RX_OS_JESD_S=1 RX_OS_JESD_NP=16 \
#       RX_JESD_L=4 PLL_TYPE=QPLL0 REF_CLK=491.5151515 LANE_RATE=16.22
#   JESD204B @245.76 MSPS: make JESD_MODE=8B10B TX_LANE_RATE=9.83 RX_LANE_RATE=9.83 PLL_TYPE=QPLL0 REF_CLK=245.75 LANE_RATE=9.83
#   JESD204B @122.88 MSPS: make JESD_MODE=8B10B TX_LANE_RATE=4.915 RX_LANE_RATE=4.915 PLL_TYPE=QPLL0 REF_CLK=122.875 LANE_RATE=4.915
