...
set_property -dict {PACKAGE_PIN H2}   [get_ports rx_data_p[0]]                                         ; ## C6   FMC0_DP0_M2C_P        MGTHRXP2_229  (rx_data_n[7])
set_property -dict {PACKAGE_PIN H1}   [get_ports rx_data_n[0]]                                         ; ## C7   FMC0_DP0_M2C_N        MGTHRXN2_229  (rx_data_p[7])
set_property -dict {PACKAGE_PIN J4}   [get_ports rx_data_p[1]]                                         ; ## A2   FMC0_DP1_M2C_P        MGTHRXP1_229  (rx_data_n[6])
set_property -dict {PACKAGE_PIN J3}   [get_ports rx_data_n[1]]                                         ; ## A3   FMC0_DP1_M2C_N        MGTHRXN1_229  (rx_data_p[6])
set_property -dict {PACKAGE_PIN F2}   [get_ports rx_data_p[2]]                                         ; ## A6   FMC0_DP2_M2C_P        MGTHRXP3_229  (rx_data_n[4])
set_property -dict {PACKAGE_PIN F1}   [get_ports rx_data_n[2]]                                         ; ## A7   FMC0_DP2_M2C_N        MGTHRXN3_229  (rx_data_p[4])
set_property -dict {PACKAGE_PIN K2}   [get_ports rx_data_p[3]]                                         ; ## A10  FMC0_DP3_M2C_P        MGTHRXP0_229  (rx_data_n[5])
set_property -dict {PACKAGE_PIN K1}   [get_ports rx_data_n[3]]                                         ; ## A11  FMC0_DP3_M2C_N        MGTHRXN0_229  (rx_data_p[5])
set_property -dict {PACKAGE_PIN L4}   [get_ports rx_data_p[4]]                                         ; ## A14  FMC0_DP4_M2C_P        MGTHRXP3_228  (rx_data_n[2])
set_property -dict {PACKAGE_PIN L3}   [get_ports rx_data_n[4]]                                         ; ## A15  FMC0_DP4_M2C_N        MGTHRXN3_228  (rx_data_p[2])
set_property -dict {PACKAGE_PIN P2}   [get_ports rx_data_p[5]]                                         ; ## A18  FMC0_DP5_M2C_P        MGTHRXP1_228  (rx_data_n[0])
set_property -dict {PACKAGE_PIN P1}   [get_ports rx_data_n[5]]                                         ; ## A19  FMC0_DP5_M2C_N        MGTHRXN1_228  (rx_data_p[0])
set_property -dict {PACKAGE_PIN T2}   [get_ports rx_data_p[6]]                                         ; ## B16  FMC0_DP6_M2C_P        MGTHRXP0_228  (rx_data_n[1])
set_property -dict {PACKAGE_PIN T1}   [get_ports rx_data_n[6]]                                         ; ## B17  FMC0_DP6_M2C_N        MGTHRXN0_228  (rx_data_p[1])
set_property -dict {PACKAGE_PIN M2}   [get_ports rx_data_p[7]]                                         ; ## B12  FMC0_DP7_M2C_P        MGTHRXP2_228  (rx_data_n[3])
set_property -dict {PACKAGE_PIN M1}   [get_ports rx_data_n[7]]                                         ; ## B13  FMC0_DP7_M2C_N        MGTHRXN2_228  (rx_data_p[3])
...
set_property -dict {PACKAGE_PIN M6}   [get_ports tx_data_p[4]]                                         ; ## A34  FMC0_DP4_C2M_P        MGTHTXP3_228  (tx_data_n[7])
set_property -dict {PACKAGE_PIN M5}   [get_ports tx_data_n[4]]                                         ; ## A35  FMC0_DP4_C2M_N        MGTHTXN3_228  (tx_data_p[7])
set_property -dict {PACKAGE_PIN P6}   [get_ports tx_data_p[5]]                                         ; ## A38  FMC0_DP5_C2M_P        MGTHTXP1_228  (tx_data_n[6])
set_property -dict {PACKAGE_PIN P5}   [get_ports tx_data_n[5]]                                         ; ## A39  FMC0_DP5_C2M_N        MGTHTXN1_228  (tx_data_p[6])
set_property -dict {PACKAGE_PIN R4}   [get_ports tx_data_p[6]]                                         ; ## B36  FMC0_DP6_C2M_P        MGTHTXP0_228  (tx_data_n[5])
set_property -dict {PACKAGE_PIN R3}   [get_ports tx_data_n[6]]                                         ; ## B37  FMC0_DP6_C2M_N        MGTHTXN0_228  (tx_data_p[5])
set_property -dict {PACKAGE_PIN N4}   [get_ports tx_data_p[7]]                                         ; ## B32  FMC0_DP7_C2M_P        MGTHTXP2_228  (tx_data_n[4])
set_property -dict {PACKAGE_PIN N3}   [get_ports tx_data_n[7]]                                         ; ## B33  FMC0_DP7_C2M_N        MGTHTXN2_228  (tx_data_p[4])
