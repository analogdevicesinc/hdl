...
# Input data driven the peripherals toggles every 4 cycles of the capture clock i3c_clk_bus (PP)
set_multicycle_path -from [get_ports i3c_controller_0_sda] -to i_system_wrapper/system_i/i3c_controller_0/core/inst/i_i3c_controller_word/sdo_reg_reg/D -setup 4
set_multicycle_path -from [get_ports i3c_controller_0_sda] -to i_system_wrapper/system_i/i3c_controller_0/core/inst/i_i3c_controller_word/sdo_reg_reg/D -hold 1

# Notes
# rising/fall time for SCL is 150e06 * 1 / fSCL, worse at fSCL = 12.5 MHz => 12ns
