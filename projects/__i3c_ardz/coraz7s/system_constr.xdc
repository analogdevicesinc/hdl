...
create_generated_clock -name i3c_clk_0 -source [get_pins -filter name=~*CLKIN1 -of [get_cells -hier -filter name=~*i3c_clkgen*i_mmcm]] -master_clock clk_fpga_0 [get_pins -filter name=~*CLKOUT0 -of [get_cells -hier -filter name=~*i3c_clkgen*i_mmcm]]
create_generated_clock -name i3c_clk_1 -source [get_pins -filter name=~*CLKIN1 -of [get_cells -hier -filter name=~*i3c_clkgen*i_mmcm]] -master_clock clk_fpga_0 [get_pins -filter name=~*CLKOUT1 -of [get_cells -hier -filter name=~*i3c_clkgen*i_mmcm]]
...
set i3c_clock_0 [get_clocks  "i3c_clk_0"]
set i3c_clock_1 [get_clocks  "i3c_clk_1"]

# Input data driven the peripherals toggles every 4 cycles max of the capture clock (PP)
