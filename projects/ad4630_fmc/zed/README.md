...
```
make CLK_MODE=0 NUM_OF_SDI=8
```

#### Clock mode ECHO, MISO lines 2, Capture zone 2, SDR

```
make CLK_MODE=1 NUM_OF_SDI=2 CAPTURE_ZONE=2
```

#### Clock mode ECHO, MISO lines 4, Capture zone 2, SDR

```
make CLK_MODE=1 NUM_OF_SDI=4 CAPTURE_ZONE=2
```

#### Clock mode ECHO, MISO lines 8, Capture zone 2, SDR

```
make CLK_MODE=1 NUM_OF_SDI=8 CAPTURE_ZONE=2
```
...
```
make CLK_MODE=0 NUM_OF_SDI=1 CAPTURE_ZONE=1 NO_REORDER=1
```

#### Clock mode SPI, MISO lines 2, Capture zone 1, SDR (ad4630)

```
make CLK_MODE=0 NUM_OF_SDI=2 CAPTURE_ZONE=1 NO_REORDER=1
```
