...
module prcfg  (
  ...
  assign dma_dac_rd_valid = core_dac_valid_in;
  assign dma_dac_rd_underflow = core_dac_underflow;
  assign dma_adc_wr_overflow = core_adc_overflow;
