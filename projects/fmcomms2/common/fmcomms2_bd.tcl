...
if {$sys_zynq == 0} {
    ...
    connect_bd_net -net sys_200m_resetn [get_bd_pins axi_ad9361_dac_dma/m_src_axi_aresetn]
    ...
    connect_bd_net -net sys_200m_resetn [get_bd_pins axi_ad9361_adc_dma/m_dest_axi_aresetn]
} else {
