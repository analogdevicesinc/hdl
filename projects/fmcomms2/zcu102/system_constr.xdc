...
set_property  -dict {PACKAGE_PIN  AB3   IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports rx_data_in_p[3]]       ; ## D11  FMC_HPC0_LA05_P
set_property  -dict {PACKAGE_PIN  AC3   IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports rx_data_in_n[3]]       ; ## D12  FMC_HPC0_LA05_N
set_property  -dict {PACKAGE_PIN  AC2   IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports rx_data_in_p[4]]       ; ## C10  FMC_HPC0_LA06_P
set_property  -dict {PACKAGE_PIN  AC1   IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports rx_data_in_n[4]]       ; ## C11  FMC_HPC0_LA06_N
set_property  -dict {PACKAGE_PIN  U5    IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports rx_data_in_p[5]]       ; ## H13  FMC_HPC0_LA07_P
set_property  -dict {PACKAGE_PIN  U4    IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports rx_data_in_n[5]]       ; ## H14  FMC_HPC0_LA07_N
