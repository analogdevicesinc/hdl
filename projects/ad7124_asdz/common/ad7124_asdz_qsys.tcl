...
add_interface ad7124_spi_cs         conduit end
add_interface ad7124_spi_sdi        conduit end
add_interface ad7124_spi_sdo        conduit end
...
add_interface ad7124_spi_clk        clock source
set_interface_property ad7124_spi_clk     EXPORT_OF clock_bridge_0.out_clk
