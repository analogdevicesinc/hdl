...
set hier_spi_engine spi_ad41xx
...
ad_ip_instance axi_dmac axi_ad41xx_dma
ad_ip_parameter axi_ad41xx_dma CONFIG.DMA_TYPE_SRC 1
ad_ip_parameter axi_ad41xx_dma CONFIG.DMA_TYPE_DEST 0
ad_ip_parameter axi_ad41xx_dma CONFIG.CYCLIC 0
ad_ip_parameter axi_ad41xx_dma CONFIG.SYNC_TRANSFER_START 0
ad_ip_parameter axi_ad41xx_dma CONFIG.AXI_SLICE_SRC 0
ad_ip_parameter axi_ad41xx_dma CONFIG.AXI_SLICE_DEST 1
ad_ip_parameter axi_ad41xx_dma CONFIG.DMA_2D_TRANSFER 0
ad_ip_parameter axi_ad41xx_dma CONFIG.DMA_DATA_WIDTH_SRC 32
ad_ip_parameter axi_ad41xx_dma CONFIG.DMA_DATA_WIDTH_DEST 64

ad_connect $sys_cpu_clk spi_clkgen/clk
ad_connect spi_clk spi_clkgen/clk_0

ad_connect axi_ad41xx_dma/s_axis $hier_spi_engine/M_AXIS_SAMPLE
ad_connect $hier_spi_engine/m_spi adc_spi

ad_connect $sys_cpu_clk $hier_spi_engine/clk
ad_connect spi_clk $hier_spi_engine/spi_clk
ad_connect spi_clk axi_ad41xx_dma/s_axis_aclk
ad_connect sys_cpu_resetn $hier_spi_engine/resetn
ad_connect sys_cpu_resetn axi_ad41xx_dma/m_dest_axi_aresetn

# AXI address definitions

ad_cpu_interconnect 0x44a00000 $hier_spi_engine/${hier_spi_engine}_axi_regmap
ad_cpu_interconnect 0x44a30000 axi_ad41xx_dma
ad_cpu_interconnect 0x44a70000 spi_clkgen

# interrupts

ad_cpu_interrupt "ps-13" "mb-13" axi_ad41xx_dma/irq
ad_cpu_interrupt "ps-12" "mb-12" $hier_spi_engine/irq

# memory interconnects

ad_mem_hp1_interconnect $sys_cpu_clk sys_ps7/S_AXI_HP1
ad_mem_hp1_interconnect $sys_cpu_clk axi_ad41xx_dma/m_dest_axi
