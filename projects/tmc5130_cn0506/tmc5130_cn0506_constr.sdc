...
ldc_set_location -site {J5} [get_ports stop_motor];      ## SW1
ldc_set_location -site {J2} [get_ports increase_speed];  ## SW4
ldc_set_location -site {J3} [get_ports decrease_speed];  ## SW5
