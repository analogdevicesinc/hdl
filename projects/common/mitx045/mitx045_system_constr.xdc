...
set_property  -dict {PACKAGE_PIN  D14  IOSTANDARD LVCMOS18} [get_ports hdmi_hsync]
set_property  -dict {PACKAGE_PIN  E16  IOSTANDARD LVCMOS18} [get_ports hdmi_data_e]
set_property  -dict {PACKAGE_PIN  G17  IOSTANDARD LVCMOS18} [get_ports hdmi_data[0]]
set_property  -dict {PACKAGE_PIN  G16  IOSTANDARD LVCMOS18} [get_ports hdmi_data[1]]
set_property  -dict {PACKAGE_PIN  H16  IOSTANDARD LVCMOS18} [get_ports hdmi_data[2]]
set_property  -dict {PACKAGE_PIN  J16  IOSTANDARD LVCMOS18} [get_ports hdmi_data[3]]
set_property  -dict {PACKAGE_PIN  G15  IOSTANDARD LVCMOS18} [get_ports hdmi_data[4]]
set_property  -dict {PACKAGE_PIN  F15  IOSTANDARD LVCMOS18} [get_ports hdmi_data[5]]
set_property  -dict {PACKAGE_PIN  J15  IOSTANDARD LVCMOS18} [get_ports hdmi_data[6]]
set_property  -dict {PACKAGE_PIN  K15  IOSTANDARD LVCMOS18} [get_ports hdmi_data[7]]
set_property  -dict {PACKAGE_PIN  F14  IOSTANDARD LVCMOS18} [get_ports hdmi_data[8]]
set_property  -dict {PACKAGE_PIN  G14  IOSTANDARD LVCMOS18} [get_ports hdmi_data[9]]
set_property  -dict {PACKAGE_PIN  F13  IOSTANDARD LVCMOS18} [get_ports hdmi_data[10]]
set_property  -dict {PACKAGE_PIN  G12  IOSTANDARD LVCMOS18} [get_ports hdmi_data[11]]
set_property  -dict {PACKAGE_PIN  E13  IOSTANDARD LVCMOS18} [get_ports hdmi_data[12]]
set_property  -dict {PACKAGE_PIN  D13  IOSTANDARD LVCMOS18} [get_ports hdmi_data[13]]
set_property  -dict {PACKAGE_PIN  F12  IOSTANDARD LVCMOS18} [get_ports hdmi_data[14]]
set_property  -dict {PACKAGE_PIN  E12  IOSTANDARD LVCMOS18} [get_ports hdmi_data[15]]
