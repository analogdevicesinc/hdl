...
# Quad 231; U145; QSFP+ Module QSFP1
...
# Quad 232; U123; QSFP+ Module QSFP2
...
# set_property LOC CMACE4_X0Y8 [get_cells -hierarchical -filter "NAME =~ */qsfp[0].qsfp_cmac_inst/cmac_inst/inst/i_cmac_usplus_top/* && REF_NAME==CMACE4"]

# 156.25 MHz MGT reference clock
create_clock -period 6.400 -name qsfp_mgt_refclk [get_ports "qsfp_mgt_refclk_p"]

set_false_path -to [get_ports "qsfp_modsell"]
set_false_path -to [get_ports "qsfp_resetl"]
set_false_path -to [get_ports "qsfp_lpmode"]
set_false_path -from [get_ports "qsfp_modprsl"]
set_false_path -from [get_ports "qsfp_intl"]
