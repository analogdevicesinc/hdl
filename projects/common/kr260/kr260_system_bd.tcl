...
# create board design
# Note: KR260 carrier board definition not available in Vivado 2025.1
# Using K26 SOM base configuration instead
# set_property board_connections {som240_1_connector xilinx.com:kr260_carrier:som240_1_connector:1.3} [current_project]
...
set sys_250m_clk          [get_bd_nets sys_250m_clk]
set sys_500m_clk          [get_bd_nets sys_500m_clk]

set sys_cpu_reset         [get_bd_pins sys_rstgen/peripheral_reset]
set sys_cpu_resetn        [get_bd_pins sys_rstgen/peripheral_aresetn]
set sys_250m_reset        [get_bd_pins sys_250m_rstgen/peripheral_reset]
set sys_250m_resetn       [get_bd_pins sys_250m_rstgen/peripheral_aresetn]
set sys_500m_reset        [get_bd_pins sys_500m_rstgen/peripheral_reset]
set sys_500m_resetn       [get_bd_pins sys_500m_rstgen/peripheral_aresetn]
...
ad_ip_parameter sys_concat_intc CONFIG.NUM_PORTS 8

ad_connect  sys_concat_intc/dout sys_ps8/pl_ps_irq0
...
ad_connect  sys_cpu_clk axi_sysid_0/s_axi_aclk
ad_connect  sys_cpu_resetn axi_sysid_0/s_axi_aresetn
