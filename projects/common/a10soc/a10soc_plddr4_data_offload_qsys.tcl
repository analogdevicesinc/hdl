...
proc ad_data_offload_create {data_offload_name} {
  ...
  add_connection sys_ddr4_cntrl.emif_usr_reset_reset_source $data_offload_name.m_axi_aresetn
  add_connection sys_ddr4_cntrl.emif_usr_clk_clock_source $data_offload_name.m_axi_aclk
  add_connection sys_ddr4_cntrl.status_conduit_end $data_offload_name.ddr_calib_done
  add_connection $data_offload_name.m_axi sys_ddr4_cntrl.ctrl_amm_avalon_slave_0
  set_connection_parameter_value $data_offload_name.m_axi/sys_ddr4_cntrl.ctrl_amm_avalon_slave_0 baseAddress {0x0}
