...
proc ad_plddr_data_offload_create {data_offload_name} {
  ...
  file copy -force $ad_hdl_dir/projects/common/zynq3/zynq3_plddr3_mig.prj [get_property IP_DIR \
    [get_ips [get_property CONFIG.Component_Name [get_bd_cells axi_ddr_cntrl]]]]
  ad_ip_parameter axi_ddr_cntrl CONFIG.XML_INPUT_FILE zynq3_plddr3_mig.prj
