...
create_clock -name refclk_124 -period  $rx_link_clk_period [get_ports ref_clk_p[0]]
create_clock -name refclk_126 -period  $rx_link_clk_period [get_ports ref_clk_p[2]]
create_clock -name refclk_128 -period  $rx_link_clk_period [get_ports ref_clk_p[4]]
...
# if {$ASYMMETRIC_A_B_MODE} {
  ...
  create_clock -name tx_b_device_clk     -period  $tx_device_clk_period [get_ports ref_clk_p[3]]
