...
If other configurations are desired, then the parameters from the HDL project (found in *common/dual_ad9208_bd.tcl*) need to be changed, as well as the Linux/no-OS project configurations.
