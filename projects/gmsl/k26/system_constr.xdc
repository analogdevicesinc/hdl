...
# ETH
set_property PACKAGE_PIN Y6 [get_ports sfp_mgt_refclk_0_p] ;# p5 c3
set_property PACKAGE_PIN Y5 [get_ports sfp_mgt_refclk_0_n] ;# p5 c4
create_clock -period 6.400 -name gt_ref_clk [get_ports sfp_mgt_refclk_0_p]

set_property PACKAGE_PIN T2 [get_ports sfp0_rx_p] ;# p5 b1
set_property PACKAGE_PIN T1 [get_ports sfp0_rx_n] ;# p5 b2
set_property PACKAGE_PIN R4 [get_ports sfp0_tx_p] ;# p5 b5
set_property PACKAGE_PIN R3 [get_ports sfp0_tx_n] ;# p5 b6
