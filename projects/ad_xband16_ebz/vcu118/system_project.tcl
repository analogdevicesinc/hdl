...
#   HW_REV: Used for different hardware revisions constraints:
#      OLD_REV - Builds the old hardware revision until REV C Quad-Apollo
#      NEW_REV - This is used for the latest hardware revision
...
if {[info exists ::env(HW_REV)]} {
  set hw_rev $::env(HW_REV)
} else {
  set env(HW_REV) $hw_rev
}
...
adi_project ad_xband16_ebz_vcu118 0 [list \
  HW_REV            [get_env_param HW_REV             $hw_rev] \
...
set HW_REV [get_env_param HW_REV OLD_REV]
