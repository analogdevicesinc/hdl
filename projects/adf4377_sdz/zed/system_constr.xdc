...
set_property -dict {PACKAGE_PIN E15  IOSTANDARD LVCMOS33} [get_ports spi_sclk]           ; ## D23 FMC-LA23_P 
set_property -dict {PACKAGE_PIN D20  IOSTANDARD LVCMOS33} [get_ports spi_sdi]            ; ## C22 FMC-LA18_CC_P 
set_property -dict {PACKAGE_PIN B20  IOSTANDARD LVCMOS33} [get_ports spi_sdo]            ; ## D21 FMC-LA17_CC_N
set_property -dict {PACKAGE_PIN B19  IOSTANDARD LVCMOS33} [get_ports spi_cs_n]           ; ## D20 FMC-LA17_CC_P

# Transmitter GPIO interface
set_property -dict {PACKAGE_PIN E20  IOSTANDARD LVCMOS33} [get_ports muxout]             ; ## H26 FMC-LA21_N 
set_property -dict {PACKAGE_PIN F19  IOSTANDARD LVCMOS33} [get_ports enclk2]             ; ## G25 FMC-LA22_N
set_property -dict {PACKAGE_PIN E19  IOSTANDARD LVCMOS33} [get_ports lkdet]              ; ## H25 FMC-LA21_P 
set_property -dict {PACKAGE_PIN E18  IOSTANDARD LVCMOS33} [get_ports ce]                 ; ## D27 FMC-LA26_N
set_property -dict {PACKAGE_PIN F18  IOSTANDARD LVCMOS33} [get_ports enclk1]             ; ## D26 FMC-LA26_P 
