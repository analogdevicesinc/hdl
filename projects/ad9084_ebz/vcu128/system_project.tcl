...
#
#    e.g.
#      make JESD_MODE=64B66B RX_LANE_RATE=10.3125 TX_LANE_RATE=10.3125 ASYMMETRIC_A_B_MODE=0 RX_JESD_M=4 TX_JESD_M=4 RX_JESD_L=8 TX_JESD_L=8 RX_JESD_S=1 TX_JESD_S=1 RX_JESD_NP=16 TX_JESD_NP=16 RX_KS_PER_CHANNEL=32768 TX_KS_PER_CHANNEL=32768
#
...
#   ADC_DO_MEM_TYPE : Data offload memory type for ADC side
#     0 - Internal BRAMs
#     1 - DDR
#     2 - HBM
#   DAC_DO_MEM_TYPE : Data offload memory type for DAC side
#     0 - Internal BRAMs
#     1 - DDR
#     2 - HBM
#
...
adi_project ad9084_ebz_vcu128 0 [list \
  ...
  RX_KS_PER_CHANNEL   [get_env_param RX_KS_PER_CHANNEL   65536 ] \
  TX_KS_PER_CHANNEL   [get_env_param TX_KS_PER_CHANNEL   65536 ] \
  ASYMMETRIC_A_B_MODE [get_env_param ASYMMETRIC_A_B_MODE     1 ] \
  RX_B_LANE_RATE      [get_env_param RX_B_LANE_RATE    10.3125 ] \
  TX_B_LANE_RATE      [get_env_param TX_B_LANE_RATE    10.3125 ] \
  ...
  RX_B_KS_PER_CHANNEL [get_env_param RX_B_KS_PER_CHANNEL 65536 ] \
  TX_B_KS_PER_CHANNEL [get_env_param TX_B_KS_PER_CHANNEL 65536 ] \
