...
adi_project ad9084_ebz_vcu118 0 [list \
  ...
  RX_B_LANE_RATE      [get_env_param RX_B_LANE_RATE  16.70625 ] \
  TX_B_LANE_RATE      [get_env_param TX_B_LANE_RATE  16.70625 ] \
  RX_B_JESD_M         [get_env_param RX_B_JESD_M          4 ] \
  RX_B_JESD_L         [get_env_param RX_B_JESD_L          8 ] \
  RX_B_JESD_S         [get_env_param RX_B_JESD_S          4 ] \
  RX_B_JESD_NP        [get_env_param RX_B_JESD_NP        12 ] \
  TX_B_JESD_M         [get_env_param TX_B_JESD_M          4 ] \
  TX_B_JESD_L         [get_env_param TX_B_JESD_L          8 ] \
  TX_B_JESD_S         [get_env_param TX_B_JESD_S          4 ] \
