...
proc create_reset_logic {
  ...
  set asymmetric_mode [expr $rx_num_lanes != $tx_num_lanes]
...
proc create_versal_phy {
  ...
  for {set j 0} {$j < $num_quads} {incr j} {
    ...
    if {!$asymmetric_mode} {
      ...
      set_property -dict [list \
        ...
        CONFIG.PROT0_PRESET ${transceiver}-JESD204_${jesd_mode} \
        ...
        CONFIG.PROT1_PRESET ${transceiver}-JESD204_${jesd_mode} \
      ] [get_bd_cells ${ip_name}/gt_quad_base_${j}]
  ...
  create_reset_logic $ip_name $rx_num_lanes $tx_num_lanes
}
