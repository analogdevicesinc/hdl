...
module system_top #(
 ...
 input          hsci_do_n,
  ...
  assign gpio_i[53] = gpio_o[53] | trig_in;

  assign trig_a[0]  = gpio_o[58] | trig_channel[0];
  assign trig_a[1]  = gpio_o[59] | trig_channel[1];
  assign trig_b[0]  = gpio_o[60] | trig_channel[2];
  assign trig_b[1]  = gpio_o[61] | trig_channel[3];
