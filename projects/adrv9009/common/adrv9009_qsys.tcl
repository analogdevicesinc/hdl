...
add_instance $dac_data_offload_name avl_data_offload
...
set_instance_parameter_value $dac_data_offload_name {DESTINATION_DWIDTH} $dac_dma_data_width
...
add_connection sys_dma_clk.clk axi_adrv9009_tx_dma.m_axis_aclk
...
ad_cpu_interconnect 0x00034000 $dac_data_offload_name.s_axi
