...
set_property  -dict {PACKAGE_PIN  W16     IOSTANDARD  LVCMOS18} [get_ports  clkout_out]   ; ## (lb: none)         U1,W16,IO_L18_34_JX4_N,JX4,70,IO_L18_34_JX4_N,P7,32

## push-buttons- led- dip-switches- loopbacks- (ps7 gpio)

set_property  -dict {PACKAGE_PIN  Y14     IOSTANDARD  LVCMOS18} [get_ports  gpio_bd[0]]   ; ## (lb: none)         U1,Y14,IO_L08_34_JX4_N,JX4,38,PB_GPIO_1,P6,19
set_property  -dict {PACKAGE_PIN  T16     IOSTANDARD  LVCMOS18} [get_ports  gpio_bd[1]]   ; ## (lb: none)         U1,T16,IO_L09_34_JX4_P,JX4,41,PB_GPIO_2,P6,26
set_property  -dict {PACKAGE_PIN  U17     IOSTANDARD  LVCMOS18} [get_ports  gpio_bd[2]]   ; ## (lb: none)         U1,U17,IO_L09_34_JX4_N,JX4,43,PB_GPIO_3,P6,28
set_property  -dict {PACKAGE_PIN  Y19     IOSTANDARD  LVCMOS18} [get_ports  gpio_bd[3]]   ; ## (lb: none)         U1,Y19,IO_L17_34_JX4_N,JX4,69,LED_GPIO_0,P7,16
...
set_property  -dict {PACKAGE_PIN  V16     IOSTANDARD  LVCMOS18} [get_ports  gpio_bd[7]]   ; ## (lb: none)         U1,V16,IO_L18_34_JX4_P,JX4,68,IO_L18_34_JX4_P,P7,30

## ps7- fixed io- to- fpga regular io (ps7 gpio)

set_property  -dict {PACKAGE_PIN  V15     IOSTANDARD  LVCMOS18} [get_ports  gpio_bd[8]]   ; ## U1,V15,IO_L10_34_JX4_P,JX4,42,IO_L10_34_JX4_P,P6,25 (U1,E9,PS_MIO10_500_JX4,JX4,87,PS_MIO10_500_JX4,P6,23)
set_property  -dict {PACKAGE_PIN  Y18     IOSTANDARD  LVCMOS18} [get_ports  gpio_bd[9]]   ; ## U1,Y18,IO_L17_34_JX4_P,JX4,67,IO_L17_34_JX4_P,P6,9  (U1,B9,PS_MIO51_501_JX4,JX4,100,PS_MIO51_501_JX4,P6,11)
set_property  -dict {PACKAGE_PIN  Y17     IOSTANDARD  LVCMOS18} [get_ports  gpio_bd[10]]  ; ## U1,Y17,IO_L07_34_JX4_N,JX4,37,IO_L07_34_JX4_N,P6,20 (U1,C8,PS_MIO15_500_JX4,JX4,85,PS_MIO15_500_JX4,P6,21)
...
set_property  -dict {PACKAGE_PIN  T20     IOSTANDARD  LVCMOS18} [get_ports  gp_out[22]]   ; ## U1,T20,IO_L15_34_JX4_P,JX4,57,IO_L15_34_JX4_P,P7,6
set_property  -dict {PACKAGE_PIN  V20     IOSTANDARD  LVCMOS18} [get_ports  gp_in[22]]    ; ## U1,V20,IO_L16_34_JX4_P,JX4,58,IO_L16_34_JX4_P,P7,5
set_property  -dict {PACKAGE_PIN  U20     IOSTANDARD  LVCMOS18} [get_ports  gp_out[23]]   ; ## U1,U20,IO_L15_34_JX4_N,JX4,59,IO_L15_34_JX4_N,P7,8
set_property  -dict {PACKAGE_PIN  W20     IOSTANDARD  LVCMOS18} [get_ports  gp_in[23]]    ; ## U1,W20,IO_L16_34_JX4_N,JX4,60,IO_L16_34_JX4_N,P7,7
set_property  -dict {PACKAGE_PIN  R16     IOSTANDARD  LVCMOS18} [get_ports  gp_out[24]]   ; ## U1,R16,IO_L19_34_JX4_P,JX4,73,IO_L19_34_JX4_P,P7,18
set_property  -dict {PACKAGE_PIN  T17     IOSTANDARD  LVCMOS18} [get_ports  gp_in[24]]    ; ## U1,T17,IO_L20_34_JX4_P,JX4,74,IO_L20_34_JX4_P,P7,17
set_property  -dict {PACKAGE_PIN  R17     IOSTANDARD  LVCMOS18} [get_ports  gp_out[25]]   ; ## U1,R17,IO_L19_34_JX4_N,JX4,75,IO_L19_34_JX4_N,P7,20
set_property  -dict {PACKAGE_PIN  R18     IOSTANDARD  LVCMOS18} [get_ports  gp_in[25]]    ; ## U1,R18,IO_L20_34_JX4_N,JX4,76,IO_L20_34_JX4_N,P7,19
set_property  -dict {PACKAGE_PIN  V17     IOSTANDARD  LVCMOS18} [get_ports  gp_out[26]]   ; ## U1,V17,IO_L21_34_JX4_P,JX4,77,IO_L21_34_JX4_P,P7,26
set_property  -dict {PACKAGE_PIN  W18     IOSTANDARD  LVCMOS18} [get_ports  gp_in[26]]    ; ## U1,W18,IO_L22_34_JX4_P,JX4,78,IO_L22_34_JX4_P,P7,25
set_property  -dict {PACKAGE_PIN  V18     IOSTANDARD  LVCMOS18} [get_ports  gp_out[27]]   ; ## U1,V18,IO_L21_34_JX4_N,JX4,79,IO_L21_34_JX4_N,P7,28
set_property  -dict {PACKAGE_PIN  W19     IOSTANDARD  LVCMOS18} [get_ports  gp_in[27]]    ; ## U1,W19,IO_L22_34_JX4_N,JX4,80,IO_L22_34_JX4_N,P7,27
