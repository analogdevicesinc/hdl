...
module system_top #(
  ...
  wire [RX_JESD_L-1:0]    jesd204_phy_o_src_rs_req_src_rs_req;
  wire [RX_OS_JESD_L-1:0] jesd204_phy_os_o_src_rs_req_src_rs_req;
  ...
  // ADXCVR -> PHY
  wire [RX_JESD_L-1:0]    jesd204_phy_rx_is_lockedtodata_o_rx_is_lockedtodata;
  wire [RX_OS_JESD_L-1:0] jesd204_phy_os_rx_is_lockedtodata_o_rx_is_lockedtodata;

  // The reset sequencer covers both PHYs, the RX lanes occupying the low half.
  assign gts_reset_i_src_rs_req_src_rs_req = {jesd204_phy_os_o_src_rs_req_src_rs_req,
                                              jesd204_phy_o_src_rs_req_src_rs_req};
   ...
   * sequencer; the others are left unconnected. The RX OS PHY's is deliberately
   * unused.
   */
  assign gts_reset_i_src_rs_refclk_status_bus_refclk_status_bus_out =
    jesd204_phy_o_refclk_bus_out_refclk_bus_out;
  ...
  system_bd i_system_bd (
    ...
    .jesd204_phy_o_src_rs_req_src_rs_req                        (jesd204_phy_o_src_rs_req_src_rs_req),
    ...
    .mxfe_rx_jesd204_rx_is_lockedtodata_o_rx_is_lockedtodata    (jesd204_phy_rx_is_lockedtodata_o_rx_is_lockedtodata),
    ...
    .jesd204_phy_os_o_src_rs_req_src_rs_req                        (jesd204_phy_os_o_src_rs_req_src_rs_req),
    .jesd204_phy_os_o_refclk_status_bus_out_refclk_status_bus_out  (jesd204_phy_os_o_refclk_bus_out_refclk_bus_out),
    .jesd204_phy_os_i_refclk_cmd_bus_in_refclk_cmd_bus_in          (gts_reset_o_src_rs_refclk_cmd_bus_refclk_cmd_bus_in),
    .jesd204_phy_os_rx_is_lockedtodata_o_rx_is_lockedtodata        (jesd204_phy_os_rx_is_lockedtodata_o_rx_is_lockedtodata),
    .mxfe_rx_os_jesd204_rx_is_lockedtodata_o_rx_is_lockedtodata    (jesd204_phy_os_rx_is_lockedtodata_o_rx_is_lockedtodata),
    ...
    .system_pll_lock_os_o_pll_lock                           (syspll_lock),
