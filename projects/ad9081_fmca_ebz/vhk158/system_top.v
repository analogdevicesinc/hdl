...
module system_top  #(
  ...
  system_wrapper i_system_wrapper (
    ...
    .ddr4_dimm0_sma_clk_clk_n (sys_clk_n),
    .ddr4_dimm0_sma_clk_clk_p (sys_clk_p),

    .ddr4_dimm0_act_n (ddr4_act_n),
    .ddr4_dimm0_adr (ddr4_adr),
    .ddr4_dimm0_alert_n (ddr4_alert_n),
    .ddr4_dimm0_ba (ddr4_ba),
    .ddr4_dimm0_bg (ddr4_bg),
    .ddr4_dimm0_ck_c (ddr4_ck_c),
    .ddr4_dimm0_ck_t (ddr4_ck_t),
    .ddr4_dimm0_cke (ddr4_cke),
    .ddr4_dimm0_cs_n (ddr4_cs_n),
    .ddr4_dimm0_dq (ddr4_dq),
    .ddr4_dimm0_dqs_c (ddr4_dqs_c),
    .ddr4_dimm0_dqs_t (ddr4_dqs_t),
    .ddr4_dimm0_odt (ddr4_odt),
    .ddr4_dimm0_par (ddr4_par),
    .ddr4_dimm0_reset_n (ddr4_reset_n),
