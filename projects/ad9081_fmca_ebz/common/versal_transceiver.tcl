...
proc create_versal_phy {
  ...
  # Export AXI interfaces
  for {set j 0} {$j < $num_quads} {incr j} {
    create_bd_intf_pin -mode Slave -vlnv	xilinx.com:interface:aximm_rtl:1.0 ${ip_name}/AXI_LITE_${j}
    ad_connect ${ip_name}/AXI_LITE_${j} ${ip_name}/gt_quad_base_${j}/AXI_LITE
  }
}
