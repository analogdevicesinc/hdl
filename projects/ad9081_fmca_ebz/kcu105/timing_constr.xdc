...
create_clock -name refclk         -period  [expr $rx_link_clk_period] [get_ports fpga_refclk_in_p]
create_clock -name refclk_replica -period  [expr $rx_link_clk_period] [get_ports fpga_refclk_in_replica_p]
