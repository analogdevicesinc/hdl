...
foreach port {clkin6 fpga_syncin_0 fpga_syncin_1 sysref2} {
  set_instance_assignment -name IO_STANDARD "TRUE DIFFERENTIAL SIGNALING" -to $port
}

foreach port {fpga_syncout_0 fpga_syncout_1} {
  set_instance_assignment -name IO_STANDARD "SSTL-12" -to $port
}

foreach port {clkin6 fpga_syncin_0 sysref2} {
  set_instance_assignment -name INPUT_TERMINATION DIFFERENTIAL -to $port
}
...
# RX
set_location_assignment PIN_AP69 -to "rx_data[0]"        ; ## B12 DP6_M2C_P
set_location_assignment PIN_AR68 -to "rx_data[0](n)"     ; ## B13 DP6_M2C_M
set_location_assignment PIN_AU66 -to "rx_data[1]"        ; ## B16 DP1_C2M_P
set_location_assignment PIN_AT65 -to "rx_data[1](n)"     ; ## B17 DP1_C2M_N
set_location_assignment PIN_AV69 -to "rx_data[2]"        ; ## A18 DP5_C2M_P
set_location_assignment PIN_AW68 -to "rx_data[2](n)"     ; ## A19 DP5_C2M_N
set_location_assignment PIN_BA66 -to "rx_data[3]"        ; ## A14 DP4_M2C_P
set_location_assignment PIN_AY65 -to "rx_data[3](n)"     ; ## A15 DP4_M2C_N
set_location_assignment PIN_BB69 -to "rx_data[4]"        ; ## A10 DP3_M2C_P
set_location_assignment PIN_BC68 -to "rx_data[4](n)"     ; ## A11 DP3_M2C_N
set_location_assignment PIN_BE66 -to "rx_data[5]"        ; ## A6  DP2_M2C_P
set_location_assignment PIN_BD65 -to "rx_data[5](n)"     ; ## A7  DP2_M2C_N
set_location_assignment PIN_BF69 -to "rx_data[6]"        ; ## A2  DP1_M2C_P
set_location_assignment PIN_BG68 -to "rx_data[6](n)"     ; ## A3  DP1_M2C_N
set_location_assignment PIN_BJ66 -to "rx_data[7]"        ; ## C7  DP7_M2C_P
set_location_assignment PIN_BH65 -to "rx_data[7](n)"     ; ## C8  DP7_M2C_N
# TX
set_location_assignment PIN_AP63 -to "tx_data[0]"        ; ## B32 DP7_C2M_P
set_location_assignment PIN_AR62 -to "tx_data[0](n)"     ; ## B33 DP7_C2M_N
set_location_assignment PIN_AU60 -to "tx_data[1]"        ; ## B36 DP6_C2M_P
set_location_assignment PIN_AT59 -to "tx_data[1](n)"     ; ## B37 DP6_C2M_N
set_location_assignment PIN_AV63 -to "tx_data[2]"        ; ## A38 DP5_C2M_P
set_location_assignment PIN_AW62 -to "tx_data[2](n)"     ; ## A39 DP5_C2M_N
set_location_assignment PIN_BA60 -to "tx_data[3]"        ; ## A34 DP4_C2M_P
set_location_assignment PIN_AY59 -to "tx_data[3](n)"     ; ## A35 DP4_C2M_N
set_location_assignment PIN_BB63 -to "tx_data[4]"        ; ## A30 DP3_C2M_P
set_location_assignment PIN_BC62 -to "tx_data[4](n)"     ; ## A31 DP3_C2M_N
set_location_assignment PIN_BE60 -to "tx_data[5]"        ; ## A26 DP2_C2M_P
set_location_assignment PIN_BD59 -to "tx_data[5](n)"     ; ## A27 DP2_C2M_N
set_location_assignment PIN_BF63 -to "tx_data[6]"        ; ## A22 DP1_C2M_P
set_location_assignment PIN_BG62 -to "tx_data[6](n)"     ; ## A23 DP1_C2M_N
set_location_assignment PIN_BJ60 -to "tx_data[7]"        ; ## C2  DP0_C2M_P
set_location_assignment PIN_BH59 -to "tx_data[7](n)"     ; ## C3  DP0_C2M_N
...
#set_location_assignment PIN_K2 -to "mux_fpga_clkin"      ; ## MUX_SEL1
# HIGH to supply CLKIN8_P/N (unused)
#set_location_assignment PIN_K1 -to ""                   ; ## MUX_SEL2
...
# set_instance_assignment -name IO_STANDARD "1.2V" -to "fpga_syncin_1"
# set_instance_assignment -name IO_STANDARD "1.2V" -to "fpga_syncin_1(n)"
# set_instance_assignment -name IO_STANDARD "1.2V" -to "fpga_syncout_0"
# set_instance_assignment -name IO_STANDARD "1.2V" -to "fpga_syncout_0(n)"
# set_instance_assignment -name IO_STANDARD "1.2V" -to "fpga_syncout_1"
# set_instance_assignment -name IO_STANDARD "1.2V" -to "fpga_syncout_1(n)"
