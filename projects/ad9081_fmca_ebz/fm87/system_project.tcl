...
set_global_assignment -name VERILOG_FILE ./mr_rate_detect.v
...
# set_instance_assignment -name IO_STANDARD "HSTL-12" -to fpga_syncout_0
...
set_instance_assignment -name IO_STANDARD "True Differential Signaling" -to sysref2
set_instance_assignment -name IO_STANDARD "True Differential Signaling" -to clkin6
set_instance_assignment -name IO_STANDARD "CML" -to fpga_refclk_in
...
set common_lanes 8
# set common_lanes [get_env_param RX_JESD_L 8]
# if {$common_lanes > [get_env_param TX_JESD_L 8]} {
#   set common_lanes [get_env_param TX_JESD_L 8]
# }
