...
set_property  -dict {PACKAGE_PIN  AH2 } [get_ports tx_data_p[0]]                                      ; ## A34  FMC_HPC_DP4_C2M_P       
set_property  -dict {PACKAGE_PIN  AH1 } [get_ports tx_data_n[0]]                                      ; ## A35  FMC_HPC_DP4_C2M_N       
set_property  -dict {PACKAGE_PIN  AF2 } [get_ports tx_data_p[1]]                                      ; ## A38  FMC_HPC_DP5_C2M_P       
set_property  -dict {PACKAGE_PIN  AF1 } [get_ports tx_data_n[1]]                                      ; ## A39  FMC_HPC_DP5_C2M_N       
set_property  -dict {PACKAGE_PIN  AE4 } [get_ports tx_data_p[2]]                                      ; ## B36  FMC_HPC_DP6_C2M_P       
set_property  -dict {PACKAGE_PIN  AE3 } [get_ports tx_data_n[2]]                                      ; ## B37  FMC_HPC_DP6_C2M_N       
...
set_property  -dict {PACKAGE_PIN  T24   IOSTANDARD LVCMOS25} [get_ports spi_csn_adf4355_1]            ; ## H22  FMC_HPC_LA19_P             
set_property  -dict {PACKAGE_PIN  T25   IOSTANDARD LVCMOS25} [get_ports spi_csn_adf4355_2]            ; ## H23  FMC_HPC_LA19_N             
set_property  -dict {PACKAGE_PIN  W29   IOSTANDARD LVCMOS25} [get_ports spi_csn_hmc1044_1]            ; ## H25  FMC_HPC_LA21_P             
set_property  -dict {PACKAGE_PIN  W30   IOSTANDARD LVCMOS25} [get_ports spi_csn_hmc1044_2]            ; ## H26  FMC_HPC_LA21_N             
set_property  -dict {PACKAGE_PIN  AB24  IOSTANDARD LVCMOS25} [get_ports spi_csn_hmc1044_3]            ; ## G19  FMC_HPC_LA16_N             
set_property  -dict {PACKAGE_PIN  V23   IOSTANDARD LVCMOS25} [get_ports spi_csn_adl5240_1]            ; ## D20  FMC_HPC_LA17_CC_P          
set_property  -dict {PACKAGE_PIN  W24   IOSTANDARD LVCMOS25} [get_ports spi_csn_adl5240_2]            ; ## D21  FMC_HPC_LA17_CC_N          
set_property  -dict {PACKAGE_PIN  U25   IOSTANDARD LVCMOS25} [get_ports spi_csn_hmc271_1]             ; ## G21  FMC_HPC_LA20_P             
set_property  -dict {PACKAGE_PIN  V26   IOSTANDARD LVCMOS25} [get_ports spi_csn_hmc271_2]             ; ## G22  FMC_HPC_LA20_N             
set_property  -dict {PACKAGE_PIN  V28   IOSTANDARD LVCMOS25} [get_ports spi_clk]                      ; ## C26  FMC_HPC_LA27_P             
set_property  -dict {PACKAGE_PIN  V29   IOSTANDARD LVCMOS25} [get_ports spi_sdo]                      ; ## C27  FMC_HPC_LA27_N             
set_property  -dict {PACKAGE_PIN  AA22  IOSTANDARD LVCMOS25} [get_ports spi_sdi_hmc271_1]             ; ## D17  FMC_HPC_LA13_P             
set_property  -dict {PACKAGE_PIN  AA23  IOSTANDARD LVCMOS25} [get_ports spi_sdi_hmc271_2]             ; ## D18  FMC_HPC_LA13_N             
...
set_property  -dict {PACKAGE_PIN  T29   IOSTANDARD LVCMOS25} [get_ports clk_gpio1]                    ; ## G27  FMC_HPC_LA25_P
set_property  -dict {PACKAGE_PIN  U29   IOSTANDARD LVCMOS25} [get_ports clk_gpio2]                    ; ## G28  FMC_HPC_LA25_N
set_property  -dict {PACKAGE_PIN  T30   IOSTANDARD LVCMOS25} [get_ports clk_gpio3]                    ; ## H28  FMC_HPC_LA24_P
set_property  -dict {PACKAGE_PIN  U30   IOSTANDARD LVCMOS25} [get_ports clk_gpio3]                    ; ## H29  FMC_HPC_LA24_N
