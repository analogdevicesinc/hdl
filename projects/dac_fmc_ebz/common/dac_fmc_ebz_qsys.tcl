...
add_connection dac_dma.if_m_axis_valid avl_dac_fifo.if_dma_valid
add_connection dac_dma.if_m_axis_data avl_dac_fifo.if_dma_data
add_connection dac_dma.if_m_axis_last avl_dac_fifo.if_dma_xfer_last
add_connection dac_dma.if_m_axis_xfer_req avl_dac_fifo.if_dma_xfer_req
add_connection avl_dac_fifo.if_dma_ready dac_dma.if_m_axis_ready
