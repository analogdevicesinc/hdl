...
set_property IOSTANDARD LVDS [get_ports ddr4_ref_1_clk_n]
...
set_property IOSTANDARD LVDS [get_ports core_clk_a_p]
set_property DIFF_TERM_ADV TERM_100 [get_ports core_clk_a_p]
set_property PACKAGE_PIN AU6 [get_ports core_clk_a_p]
set_property PACKAGE_PIN AV6 [get_ports core_clk_a_n]
set_property IOSTANDARD LVDS [get_ports core_clk_a_n]
set_property DIFF_TERM_ADV TERM_100 [get_ports core_clk_a_n]
set_property PACKAGE_PIN AV8 [get_ports core_clk_b_p]
set_property IOSTANDARD LVDS [get_ports core_clk_b_p]
set_property DIFF_TERM_ADV TERM_100 [get_ports core_clk_b_p]
set_property PACKAGE_PIN AV7 [get_ports core_clk_b_n]
set_property IOSTANDARD LVDS [get_ports core_clk_b_n]
set_property DIFF_TERM_ADV TERM_100 [get_ports core_clk_b_n]
...
set_property IOSTANDARD LVDS [get_ports tx_sync_a_n]
set_property DIFF_TERM_ADV TERM_100 [get_ports tx_sync_a_n]
set_property PACKAGE_PIN AU3 [get_ports tx_sync_a_p]
set_property PACKAGE_PIN AV3 [get_ports tx_sync_a_n]
set_property IOSTANDARD LVDS [get_ports tx_sync_a_p]
set_property DIFF_TERM_ADV TERM_100 [get_ports tx_sync_a_p]
set_property PACKAGE_PIN AW2 [get_ports tx_sync_a_1_n]
set_property IOSTANDARD LVDS [get_ports tx_sync_a_1_n]
set_property DIFF_TERM_ADV TERM_100 [get_ports tx_sync_a_1_n]
set_property PACKAGE_PIN AV2 [get_ports tx_sync_a_1_p]
set_property IOSTANDARD LVDS [get_ports tx_sync_a_1_p]
set_property DIFF_TERM_ADV TERM_100 [get_ports tx_sync_a_1_p]
set_property IOSTANDARD LVDS [get_ports sysref_a_n]
set_property DIFF_TERM_ADV TERM_100 [get_ports sysref_a_n]
set_property PACKAGE_PIN AT1 [get_ports sysref_a_p]
set_property PACKAGE_PIN AU1 [get_ports sysref_a_n]
set_property IOSTANDARD LVDS [get_ports sysref_a_p]
set_property DIFF_TERM_ADV TERM_100 [get_ports sysref_a_p]
...
set_property IOSTANDARD LVDS [get_ports tx_sync_b_n]
set_property DIFF_TERM_ADV TERM_100 [get_ports tx_sync_b_n]
set_property PACKAGE_PIN AK20 [get_ports tx_sync_b_p]
set_property PACKAGE_PIN AL20 [get_ports tx_sync_b_n]
set_property IOSTANDARD LVDS [get_ports tx_sync_b_p]
set_property DIFF_TERM_ADV TERM_100 [get_ports tx_sync_b_p]
set_property PACKAGE_PIN AG19 [get_ports tx_sync_b_1_n]
set_property IOSTANDARD LVDS [get_ports tx_sync_b_1_n]
set_property DIFF_TERM_ADV TERM_100 [get_ports tx_sync_b_1_n]
set_property PACKAGE_PIN AG20 [get_ports tx_sync_b_1_p]
set_property IOSTANDARD LVDS [get_ports tx_sync_b_1_p]
set_property DIFF_TERM_ADV TERM_100 [get_ports tx_sync_b_1_p]
set_property IOSTANDARD LVDS [get_ports sysref_b_n]
set_property DIFF_TERM_ADV TERM_100 [get_ports sysref_b_n]
set_property PACKAGE_PIN AP11 [get_ports sysref_b_p]
set_property PACKAGE_PIN AP10 [get_ports sysref_b_n]
...
create_clock -period 4.000 -name tx_dev_clk [get_ports core_clk_a_p]
create_clock -period 4.000 -name rx_dev_clk [get_ports core_clk_b_p]
create_clock -period 4.000 -name jesd_tx_ref_clk [get_ports ref_clk_a_p]
create_clock -period 4.000 -name jesd_rx_ref_clk [get_ports ref_clk_b_p]

set_input_delay -clock rx_dev_clk -max 4.000 [get_ports sysref_b_p]
set_input_delay -clock rx_dev_clk -min 4.000 [get_ports sysref_b_p]

set_input_delay -clock tx_dev_clk -max 4.000 [get_ports sysref_a_p]
set_input_delay -clock tx_dev_clk -min 4.000 [get_ports sysref_a_p]
