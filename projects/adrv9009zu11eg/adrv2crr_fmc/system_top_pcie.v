...
module system_top (
  ...
  // RX 8 differential pairs
  input       [7:0]   pcie_rx_p,
  input       [7:0]   pcie_rx_n,
  // TX 8 differential pairs
  ...
  assign led_gpio_0 = user_link_up;
  ...
  // pcie_ref_clk will drive xdma/sys_clk_gt, it's PCIe reference clock
  // pcie_ref_clk_div2 will drive xdma/sys_clk, IP's internal clock
  IBUFDS_GTE4 i_ibufds_ref_clk_pcie (
    .CEB (1'd0),
    .I (pcie_clk_p),
    .IB (pcie_clk_n),
    .O (pcie_ref_clk),
    .ODIV2 (pcie_ref_clk_div2));
  ...
  system_wrapper i_system_wrapper (
    ...
    .pcie_ref_clk_div2(pcie_ref_clk_div2),
