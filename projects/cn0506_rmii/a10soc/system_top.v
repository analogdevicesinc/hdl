...
module system_top (
  ...
  system_bd i_system_bd (
    ...
    .sys_hps_emac1_phy_txd_o (mii_txd_a),
    .sys_hps_emac1_phy_txen_o (mii_tx_en_a),
    .sys_hps_emac1_phy_txer_o (mii_tx_er_a),
    .sys_hps_emac1_phy_rxdv_i (mii_rx_dv_a),
    .sys_hps_emac1_phy_rxer_i (mii_rx_er_a),
    .sys_hps_emac1_phy_rxd_i (mii_rxd_a),
    .sys_hps_emac1_phy_col_i (mii_col_a),
    ...
    .sys_hps_emac2_phy_txd_o (mii_txd_b),
    .sys_hps_emac2_phy_txen_o (mii_tx_en_b),
    .sys_hps_emac2_phy_txer_o (mii_tx_er_b),
    .sys_hps_emac2_phy_rxdv_i (mii_rx_dv_b),
    .sys_hps_emac2_phy_rxer_i (mii_rx_er_b),
    .sys_hps_emac2_phy_rxd_i (mii_rxd_b),
    .sys_hps_emac2_phy_col_i (mii_col_b),
    ...
    .altera_fpga_mii2rmii_0_rmii_interface_crs (rmii_rx_dv_a),
    .altera_fpga_mii2rmii_0_rmii_interface_rxdata (rmii_rxd_a),
    .altera_fpga_mii2rmii_0_rmii_interface_rxerror (rmii_rx_er_a),
    .altera_fpga_mii2rmii_0_rmii_interface_txenable (rmii_tx_en_a),
    .altera_fpga_mii2rmii_0_rmii_interface_txdata (rmii_txd_a),

    .altera_fpga_mii2rmii_0_mii_interface_mii_tx_en (mii_tx_en_a),
    .altera_fpga_mii2rmii_0_mii_interface_mii_tx_d (mii_txd_a),
    .altera_fpga_mii2rmii_0_mii_interface_mii_tx_err (mii_tx_er_a),
    .altera_fpga_mii2rmii_0_mii_interface_mii_rx_dv (mii_rx_dv_a),
    .altera_fpga_mii2rmii_0_mii_interface_mii_rx_d (mii_rxd_a),
    .altera_fpga_mii2rmii_0_mii_interface_mii_rx_err (mii_rx_er_a),
    .altera_fpga_mii2rmii_0_mii_interface_mii_crs (mii_crs_a),
    .altera_fpga_mii2rmii_0_mii_interface_mii_col (mii_col_a),

    .altera_fpga_mii2rmii_1_rmii_interface_crs (rmii_rx_dv_b),
    .altera_fpga_mii2rmii_1_rmii_interface_rxdata (rmii_rxd_b),
    .altera_fpga_mii2rmii_1_rmii_interface_rxerror (rmii_rx_er_b),
    .altera_fpga_mii2rmii_1_rmii_interface_txenable (rmii_tx_en_b),
    .altera_fpga_mii2rmii_1_rmii_interface_txdata (rmii_txd_b),

    .altera_fpga_mii2rmii_1_mii_interface_mii_tx_en (mii_tx_en_b),
    .altera_fpga_mii2rmii_1_mii_interface_mii_tx_d (mii_txd_b),
    .altera_fpga_mii2rmii_1_mii_interface_mii_tx_err (mii_tx_er_b),
    .altera_fpga_mii2rmii_1_mii_interface_mii_rx_dv (mii_rx_dv_b),
    .altera_fpga_mii2rmii_1_mii_interface_mii_rx_d (mii_rxd_b),
    .altera_fpga_mii2rmii_1_mii_interface_mii_rx_err (mii_rx_er_b),
    .altera_fpga_mii2rmii_1_mii_interface_mii_crs (mii_crs_b),
    .altera_fpga_mii2rmii_1_mii_interface_mii_col (mii_col_b),

    .clk_bridge_0_in_clk_clk (rmii_rx_ref_clk_a),
    .clk_bridge_1_in_clk_clk (rmii_rx_ref_clk_b),

    .altera_fpga_mii2rmii_0_MACSPEED_ena_10 (mac_speed_0),
    .altera_fpga_mii2rmii_1_MACSPEED_ena_10 (mac_speed_1));
